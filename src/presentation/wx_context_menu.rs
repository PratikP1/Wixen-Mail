...
pub const fn command_for(action: Action) -> Id {
    use crate::presentation::wx_app::{
        ID_CHECK_MAIL, ID_CHOOSE_FOLDERS, ID_CONTEXT_ADD_TO_GROUP, ID_CONTEXT_COPY_ITEM,
        ID_CONTEXT_COPY_TO_EVENT, ID_CONTEXT_COPY_TO_NOTE, ID_CONTEXT_COPY_TO_TASK,
        ID_CONTEXT_DELETE_CONTAINER, ID_CONTEXT_DELETE_ITEM, ID_CONTEXT_MOVE_ITEM,
        ID_CONTEXT_NEW_CONTAINER, ID_CONTEXT_NEW_ITEM, ID_CONTEXT_REMOVE_FROM_GROUP,
        ID_CONTEXT_RENAME_CONTAINER, ID_CONTEXT_SYNC_NOW, ID_CONTEXT_TOGGLE_COMPLETE,
        ID_CONTEXT_TOGGLE_PIN, ID_CONTEXT_WRITE_TO_GROUP, ID_COPY_TO_FOLDER, ID_DELETE,
        ID_DELETE_OUTRIGHT, ID_DELETE_SEARCH, ID_EDIT_SEARCH_CONDITIONS, ID_FORWARD, ID_GET_OLDER,
        ID_MARK_READ, ID_MOVE_DOWN, ID_MOVE_TO_FOLDER, ID_MOVE_UP, ID_NEW_FOLDER,
        ID_REFRESH_FOLDER, ID_RENAME_SEARCH, ID_REPLY, ID_REPLY_ALL, ID_TAG_MGR, ID_TOGGLE_STAR,
    };
    match action {
        ...
        Action::MoveItem => ID_CONTEXT_MOVE_ITEM,
        Action::CopyItem => ID_CONTEXT_COPY_ITEM,
        Action::NewContainer => ID_CONTEXT_NEW_CONTAINER,
        Action::DeleteContainer => ID_CONTEXT_DELETE_CONTAINER,
        Action::RenameContainer => ID_CONTEXT_RENAME_CONTAINER,
        Action::WriteToGroup => ID_CONTEXT_WRITE_TO_GROUP,
        Action::AddToGroup => ID_CONTEXT_ADD_TO_GROUP,
        Action::RemoveFromGroup => ID_CONTEXT_REMOVE_FROM_GROUP,
