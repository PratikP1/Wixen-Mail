...
| 11-13 | 30 | 14 | #75 | closes | inserted 2026-09-18: every status sentence listed from the code and rewritten by hand to one shape, the refusals one per kind, a reading over the words and endings, no line moved between channels; after every plan that adds a sentence and before the closing read. Deferred to the next phase on Pratik's decision of 2026-09-20, under his token budget; 11-12 ran without it and read the bar's sentences as the phase left them |
