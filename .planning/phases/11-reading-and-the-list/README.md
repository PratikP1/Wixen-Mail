...
| 11-11.2 | 28 | 22 (second half) | #80 | closes | inserted 2026-09-18 (evening): the separate window as a process of its own started with `--show-page`, answered before the claim and the handover, its WebView2 profile of its own by the app name set before the WebView, the route reaching it, the erase reaching the profile. Deferred to the next phase on Pratik's decision of 2026-09-20, under his token budget; 11-11.3 ran without it, since their dependency was wave ordering only. Moved later that day to phase 12 as `12-02-PLAN.md` with `git mv`, its premises re-taken against `0ad66e48`; this directory holds 29 plans since |
...
| 11-13 | 30 | 14 | #75 | closes | inserted 2026-09-18: every status sentence listed from the code and rewritten by hand to one shape, the refusals one per kind, a reading over the words and endings, no line moved between channels; after every plan that adds a sentence and before the closing read. Deferred to the next phase on Pratik's decision of 2026-09-20, under his token budget; 11-12 ran without it and read the bar's sentences as the phase left them. Moved later that day to phase 12 as `12-03-PLAN.md` with `git mv`, its premises re-taken against `0ad66e48` |
| 11-12 | 31 | 13 | all twenty-seven and #25's correction | closes the phase | the pages, the listening lines, the closing read. Merged 2026-09-20 with 28 plans before it; the phase closed at 29 of 31, 11-11.2 and 11-13 deferred |
