...
| GAP-04 | Phase 13 | In progress 2026-09-26: the first `[D]` clause's "invitation's part shown and said before the body" built by 13-10, held by `tests/an_invitation_is_said_before_the_body.rs` and `application::invitations`'s cases; the answer buttons, the UID and the calendar changes wait for 13-11 to 13-13, and 13-13 ticks it. Until 13-10 "Planned 2026-09-24: 13-10 to 13-13, 13-13 ticks it; not built", and before that "Not planned, 2026-09-20" |
