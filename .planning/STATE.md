...
**Current focus:** Phase 13 (New features, most from the Outlook gap audit), 11 of 53 plans run, 13-11 the latest on 2026-09-26, Accept, Tentative and Decline as buttons in both message windows and on the message list's context menu, the answer remembered and the reply threaded; 13-12 next; after 13-10 this read "10 of 53 plans run, 13-10 the latest on 2026-09-26, a message carrying a meeting says what it is before its body on every surface; 13-11 next"; after 13-09 this read "9 of 53 plans run, 13-09 the latest on 2026-09-25, Undo and Redo of the last action on an item in the other five modules, #47 closed; 13-10 next"; after 13-08 this read "8 of 53 plans run, 13-08 the latest on 2026-09-25, Undo and Redo of the last move, delete or copy in the message list, GAP-02 ticked; 13-09 next"; after 13-07 this read "7 of 53 plans run, 13-07 the latest on 2026-09-25, Undo and Redo of the last mark, star or label in the message list; 13-08 next"; after 13-06 this read "6 of 53 plans run, 13-06 the latest on 2026-09-25, the same several steps of undo in every dialog's boxes; 13-07 next"; after 13-05 this read "5 of 53 plans run, 13-05 the latest on 2026-09-25, several steps of undo in the main window's three text boxes; 13-06 next"; after 13-04 this read "4 of 53 plans run, 13-04 the latest on 2026-09-25, Print on every surface that shows a message or an item and GAP-01 ticked; 13-05 next"; after 13-03 this read "3 of 53 plans run, 13-03 the latest on 2026-09-25; 13-04 next"; Pratik answered (a) to (d) on 2026-09-24, recorded in the phase README, and (d) waits on his test program before anything is filed. After 13-02 this read "Phase 13 (New features, most from the Outlook gap audit), 2 of 53 plans run, 13-02 the latest on 2026-09-25; 13-03 next; four answers wait on Pratik, (a) to (d) in the phase README". After planning this read "Phase 13 (New features, most from the Outlook gap audit) planned on 2026-09-24 against `main` at `630e2a67`, fifty-three plans, one per wave, nothing executed, 13-01 next; four answers wait on Pratik, (a) to (d) in the phase README". Until then this read "Phase 12 (The editors, and what the alpha still owes) complete on 2026-09-24, 16 of 16 plans merged and its full gate green; phase 13 next, planned once Pratik confirms the order inside it". After 12-12's documents commit this read "16 of 16 plans run, 12-12 the last on 2026-09-24, its full gate before its merge the phase's last step". After 12-11 this read "15 of 16 plans merged, 12-11 the latest on 2026-09-24; 12-12 next". After 12-10 this read "14 of 16 plans merged, 12-10 the latest on 2026-09-24; 12-11 next". After 12-09 this read "13 of 16 plans merged, 12-09 the latest on 2026-09-24; 12-10 next". After 12-08 this read "12 of 16 plans merged, 12-08 the latest on 2026-09-24; 12-09 next". After 12-07 this read "11 of 16 plans merged, 12-07 the latest on 2026-09-24; 12-08 next". After 12-06.1 this read "10 of 16 plans merged, 12-06.1 the latest on 2026-09-24; 12-07 next". This count read "4 of 13" until 2026-09-24, left there after 12-03 while six plans merged and three were inserted. The sentences after this one are 12-03's and 12-01's, kept as they were. 12-03 merged at `a9ce329d` on 2026-09-23: every sentence the status bar shows was read in one pass and 177 of the 205 written where they stand were rewritten to one shape, six wordings for a refusal when nothing was chosen became one for each of fifteen kinds, and a reading now holds the words and the endings and prints the 236 it cannot see; #75 closed, LIST-11 ticked, its `[S]` line ledger 574. 12-01 merged at `e29c514b` on 2026-09-22: the formatted message window gives the keyboard back to the browser whenever it is activated, measured on a built window, so the NVDA run's failure was the case's return and not the product; the case now waits for Windows to say the window is in front and writes down where its next key will go, and its green is the next push of `main`. Next: 12-02, the separate window. The plan of 2026-09-20 against `main` at `0ad66e48`, twelve plans, one per wave: 12-01 the NVDA run's red case (run 35520201976, whose record shows the route held and the case's return to the page window was the failure), 12-02 and 12-03 the two plans moved in from phase 11 with `git mv` and their premises re-taken (the separate window; the status bar's sentences), 12-04 and 12-05 the About and Send Feedback dialogs the public alpha owes, 12-06 to 12-10 the editors (spin controls and the spinner's typing-field name, the contact editor, event times in blocks, signatures per account, labels ordered), 12-11 the pro licence as a design with Pratik's decisions listed, 12-12 the closing read. Phases 13 and 14 are roadmap entries and requirements only (GAP-01 to GAP-13, REAL-01 and REAL-02), the grouping Pratik's of 2026-09-16 and the order inside each the planner's for him to confirm. Phase 11's roadmap line is ticked now that its two deferred plans left its list; its row reads 29/29. Eleven decisions are listed as Pratik's in the phase README. Next: 12-01 on a branch, then the rest in wave order. The earlier account: phase 11 closed on 2026-09-20 with 29 of its 31 plans merged: 11-12, the closing read, merged at `9ee0e9a8`, the pages saying what the list and the reader do now and that none of it has been heard, items 58 to 83 on the listening page, twenty-four LIST ticks re-read and standing, LIST-02 open on its two size rows, LIST-11 and LIST-19 open because 11-13 and 11-11.2 were deferred to the front of the next phase on Pratik's decision of 2026-09-20 under his token budget; the roadmap's phase line stays unticked for the two plans and says so; ledger 566 for the program's own sentences that still promise the separate window with the next build. Next: Pratik's push of `main` and the next phase's planner, who starts with 11-11.2 and 11-13 and then group 5, the editors. Before it, 11-11.3 merged at `6e23656b` on 2026-09-20, a Markdown block marker typed with its space counting at the start of any line of the message, a refusal that met a marker written to the log, the first character after a closing delimiter plain, a reading typing into the real editor page with posted keys, the pages saying the space in words; #79 closed; LIST-18 ticked on its [D] line; 11-11.2 deferred to the next phase on Pratik's decision of 2026-09-20; 11-13 is next. Before it, 11-11.1.3 merged at `1e39650a` on 2026-09-20, All Inboxes with a view of its own and every inbox's conversations one row per account and conversation, #92 closed. Before it, 11-11.1.2 merged at `ae0fa4d2` on 2026-09-20, a folder never set showing conversations as Show conversations by default on the Reading tab, on unless turned off, read where the folder opens, a stored nought still flat, the box after Then by named on both channels and read back, the D-09 sentences dated; #92 commented and left open for its second half; LIST-27's evidence dated, its box left; 11-11.1.3 is next. Before it, 11-11.1.1 merged at `051c3529` on 2026-09-20, a setting saved in Settings applying without a restart: Mark as read after and the four date settings in the window's state through two updates the Settings-saved arm sends, the timer and ten capture sites reading the state, every startup capture held by a reading to a list with a disposition each, the log level and the default sort order saying next start under their controls; #91 closed with the ear list; LIST-26 ticked; 11-11.1.2 is next. Before it, 11-11.1 merged at `8340e5e6` on 2026-09-20, where a link opens as a setting on the Reading tab with the browser first, the link caught in the page before the browser navigates because the veto never fired (wxdragon hands the navigating event an empty string), the three places on the link's menu on both surfaces, the message view route with its host, title, failure and way back said; 11-11.2 is next. Before it, 11-11.0 merged at `fab0ecea` on 2026-09-20, text a sender hid dropped before the sanitiser by the sender's own hiding with the invisible filler stripped and a count said once for words beyond a preheader, a layout table kept a layout table to the reader with no other role surviving, a sender's label kept only where it is a link's or a data table's name, the page's heading unnumbered for one message, the reader's structure reading the same message with its blocks apart and a layout table as blocks, the tester's newsletter a public fixture with its thirty tracking addresses replaced by hand, ledger 555 closed, #90 closed from the merge with the ear list, LIST-25 ticked; 11-11.1 is next. Before it, 11-11 merged at `f497785f` on 2026-09-20, pictures a message points at shown by default with tracking pixels and decorative ones held back by the sender's own declarations, a linked picture reading its link's words, an undescribed one passed over unless the Reading tab says image or photo, the privacy page listing every way a reader of mail can be tracked from the code; 11-11.0 is next. Before it, 11-10.1 merged at `be97ed86` on 2026-09-19, an address written out a link through one recogniser in `application::links_in_text` that agrees with the composer about brackets and with the sanitiser about what may be opened, reaching the plain-text page, a reply's quoted text, a note as a page and a description read aloud as "link to" its host, the snippet still bare and asking the same shape rule, `tel:` opened, a link the program will not open keeping its words with the note beside them on the reading path; #89 closed with the ear list; LIST-24 ticked; 11-11 is next. Before it, 11-10 merged at `39d53503` on 2026-09-19, a rule that changes how a row is announced, Say this first as a phrase kept on the message and prefixed to the row's first visible cell, the Says first and Labels columns, the Rule matched event once per check, the rule editor offering the action and the sound box; 11-10.1 is next. Before it, 11-09.2 merged at `4d9a41d2` on 2026-09-19, a message row's snippet the message's first relevant words by written rules in `application::snippet`, addresses dropped altogether, marker lines, marketing openers and a bare greeting skipped, quoted lines and the signature left out, the invisible padding of a hidden preheader dropped and a repeated line said once, the first sentences up to the limit at a sentence boundary, the least bad line when nothing survives, one derivation for the save and the pass, and every stored snippet recomputed once on the next start under a marker of its own; 11-10 is next. Before it, 11-09.1 merged at `517a2a4c` on 2026-09-19, the sounds on by default for every event, the attachment event's own default of the tone and the status bar read wherever no answer was stored so the tester's stored profile reaches it, the never-sound-alone rule unable to speak for an event whose words are on the row, and the earcon player opening the default device again on the stream's flag and after ten seconds' quiet with an outage told once; 11-09.2 is next. Before it, 11-09 merged at `bd5f6929` on 2026-09-19, `Ctrl+Shift+;` and an Action item reading the row under the cursor column by column with its headings, once, as content the mute controls, composed from the very cells the list paints so a conversation row reads its own; the header on every row NVDA's own setting, with the shortcuts page giving the three routes and the steps for an application-triggered profile; #26 closed with the ear list; LIST-07 ticked; 11-09.1 is next. Before it, 11-08.1 merged at `76897058` on 2026-09-19, a conversation on Gmail being the one Gmail shows, `X-GM-THRID` asked for and naming the conversation here over the headers, a name the server gave never rewritten, the loaded page grouped and named as the store groups it so the conversation window finds a row's messages, mail already stored given its word once at the next check, the late-parent trace finding the store already joined those cases; #88 closed with the ear list; LIST-23 ticked; 11-09 is next. Before it, 11-08 merged at `75c211fe` on 2026-09-19, a conversation row standing for one message, the originator when nothing in it has been read, otherwise the first unread by arrival, chosen in SQL where the columns are and read by the cell, the sort, the preview, the conversation window, Space and every command over the cursor row; the conversation's text fetched on landing as one bounded chunk under the reading gate; the preview under conversation view no longer an unrelated message; #31 closed with the ear list; LIST-06 ticked; 11-08.1 is next. Before it, 11-07.2 merged at `2526b31f` on 2026-09-19, a move or a copy to a folder on another account completing on this computer first as well on Pratik's decision overruling 11-07.1's decision 29, the crossing a row in `moves_waiting` with the other account named and its bytes in phase 4.1's store, cut into three steps a held row resumes from, replayed at a check of either account, undone and said at a refusal, never put back when nobody could settle it, the question at start retired, a message over 25 MB server first with a sentence; #86 closed with the ear list and #63 told; LIST-22 ticked; 11-08 is next. Before it, 11-07.1 merged at `fa20d04a` on 2026-09-19, a move, a delete or a copy within one account completing here first with `moves_waiting`, the replay before the first listing, `MovePutBack` and Enter in the Move dialog. Before that, 11-07 merged at `b35a40cd` on 2026-09-19, the message list selecting more than one message and seven commands acting on the set with one sentence, a conversation row contributing its messages by a stated reach, the bound shared with Select All and measured at 75 ms for 5,000 read marks in the cache, a set's delete landing the cursor after the set, #30 and #27 closed; 11-07.1 is next. Before it, 11-06.3 merged at `1a973b46` on 2026-09-19, the gate's suite harness clearing the five git variables a commit hook hands its children before any suite's first git, two cases in `which-checks.test.sh` red against a throwaway repository if that stops, the suite run under this repository's own absolute git dir and an absolute copy of its index with nothing moved; #85 closed; ledger 536 fixed; FOUND-19 ticked; no commit was made from a linked worktree; 11-07 is next. Before it 11-06.2 merged at `116968fb` on 2026-09-19, Tab, F6 or a click into the message list landing on the remembered row or the first when the control holds no row, on the list's focus event, a list holding a row left alone, an empty list saying No messages once; a built tree and list recorded the focus events before and after; #87 closed with the ear list; 11-06.3 is next. Before it 11-06.1 merged at `0ed2c1a1` on 2026-09-19, after a delete the cursor landing on the next message, or the previous when the last went, on the control itself with the focus event raised, a re-read keeping it on the same message by identity, and Delete saying "Delete" once with its success shown for the eye and never spoken, the moves the same; a built list showed the control holds nothing after the last row goes and keeps the row otherwise; #76 and #83 closed with the ear lists; 11-06.2 is next. Before it 11-05.1 merged at `b3ab5d51` on 2026-09-18, the first Space, the short form, starting no clock towards marking a message read, the whole reading or opening starting it, which press counts one function over the depth the cycle chose, the sentence under the setting and the guide saying the whole message or opening it, #25 closed again with the ear list; 11-06.1 is next. Before it 11-06 merged at `fe143d46`, Mark as Read saying which way it will go on three surfaces and M toggling it; 11-05 merged at `5c82f680` on 2026-09-18, moving through the message list marking nothing read, reading a message aloud or opening it starting the clock the setting's wait runs from, the decision one rule in `reading_habits` held by six cases, the sentence under the setting, #25 closed; before it 11-04.1 merged at `70d84bc5` on 2026-09-18, Alt+A reaching the attachments of an open message and back in both views, through the page's script in the formatted window where the old F8 binding on the browser control never fired, and through the reader's item and its menu handler in the plain-text reader; F7 to the warning bar in the formatted window; F8 retired from both and dated on the pages; #84 closed; LIST-15 ticked on its `[D]` lines; 11-05 is next. Still a person's: the landing sentences heard, and the reader's way back through the accelerator watched (ledger 538). The earlier focus, kept as written: Phase 11 (Reading, and the list) is in progress: 11-04 merged at `03513fd0` on 2026-09-18, the log's default following the version the build carries, the lines a report needs written at info and debug with a lexical guard over every log call, the alpha page's table; #71 commented and open for #64's dialog; LIST-02 held on its rule, lines, guard and pages, its two size rows owed (ledger 537, the measurement cannot start while a copy of Wixen Mail is open); 11-04.1 is next. Still a person's: whether these are the lines a report needs (ledger 535), and the fixture defect the session found, ledger 536. The earlier focus, kept as written: Phase 11 (Reading, and the list) is in progress: 11-03 merged at `70f4737b` on 2026-09-18, Folders to Keep Up to Date a tree with the control's own check boxes, the account's name in the title, the All Mail sentence, the command on Tools, and the cause of "read-only" found in wxdragon's state numbering (ledger 534); #70 closed; LIST-01 ticked on its `[D]` lines; 11-04 is next. Still a person's: the tree heard (ledger 533). The earlier focus, kept as written: Phase 11 (Reading, and the list) is in progress: 11-02 merged at `1c0e9b0b` on 2026-09-18, the NVDA workflow's verdict its job's, the settings case counting from its first key, a sign-in failure one notification carrying the sentence, FOUND-08 ticked on the walk and FOUND-09 on the tester's ear; 11-03 is next. Still a person's: the next push of `main`, which runs CI's en-AU case (11-01), the four NVDA cases as a gate, the sign-in line whole and which tab the settings case's first Right reaches (ledger 530, 531). The earlier focus, kept as written: Phase 11 (Reading, and the list) is in progress: 11-01 merged at `316ea755` on 2026-09-18, a chosen spelling language kept as chosen where this machine cannot check it, the runner's en-AU case the next push of `main`; 11-02 is next. The earlier focus, kept as written: Phase 11 (Reading, and the list) is planned and nothing in it is executed; 11-01 is next. `main` was pushed on 2026-09-18 at `744d05ef` and the three workflows ran: CI red on one test (11-01's), the NVDA run green over a failed job (11-02's), the Accessibility run walking the five editors FOUND-08 waited on (11-02 ticks it); #33 closed the same day on the tester's ear; #72 held. Still a person's: a new installer from `main` for the third day of testing, and the next push after 11-01 merges, which is what shows CI green. The earlier focus, kept as written: Phase 10 (All the mail, and what is said while it comes) is complete, 10-07 merged at `d5529ee8` on 2026-09-18. Before it: 10-06 merged at `2da50b6b` on 2026-09-18, mail keeping arriving on its own for as long as the program runs, a watch per enabled IMAP account started again after a growing wait when it ends and at once when the network comes back, a check on the account editor's interval where a watch cannot cover, a start that checks and watches, the status line saying which, #37 closed from the merge commit; 10-07, the closing read, is next. Before it, 10-05 merged at `b477e8c9` on 2026-09-18, everything coming down on its own after every check for every enabled IMAP account, chunk by chunk with the text, the folder on screen first, paused from Tools and waited after a refusal, Download This Whole Folder and Fetch Missing Message Text gone, #20 and #23 closed; 10-06 is next. Earlier: 10-04 merged at `19a10706` on 2026-09-18, how much is said while mail is fetched a three-level setting on the Feedback tab, steps shown and spoken only under Say every step, what arrived said once with counts, the new-mail sound on a check that found mail, Settings saved heard; 10-05 is next. Earlier: 10-03 merged at `c4203632` on 2026-09-17, how much message text stays on this computer a setting on the Permissions tab, All of it by default, read by the eviction and handed to the workers that evict, 10-04 next; before it, 10-02 merged at `48536d31` on 2026-09-17, the message list holding everything the folder holds with the page of 500 gone and the labels read by folder, measured before and after at the tester's size and at 200,000, #24 closed; 10-03 is next. Before it, 10-01.1 merged at `d020aa60` on 2026-09-17, every Settings check box a check box again over MSAA and a page reached from inside a page handing focus to its first control, #67 and #68 closed. Before that, 10-01 merged at `d8e887d6` on 2026-09-17, the model, the wait rule and the chunk-bounded text pass, called by nothing yet; 10-01.1, inserted later that day for the two Settings regressions the tester found in alpha.1 (#67, #68), is next, then 10-02. Still a person's from phase 9: a push of `main` for FOUND-08's walk clause and FOUND-09's transcript clause, and a new installer for the second day of testing. The earlier focus, kept as written: Phase 09 (What the first day of testing found) is complete, 09-01 to 09-10 merged, the last at `8eba6a38` on 2026-09-17. What is left is a person's: a push of `main` for FOUND-08's walk clause and FOUND-09's transcript clause, a new installer for the second day of testing, and the README's groups 3 to 7 for the next phase. The focus before that, kept as written: Phase 08 (Every number the project quotes) is complete, 08-01 to 08-09 merged, and it was the last phase of the milestone; what is left is a person's, and Current Position says what

## Current Position

Phase: 13 (New features, most from the Outlook gap audit). Current plan 11 of 53: 13-11
done on 2026-09-26, 13-12 next. Until 13-11 this line read "Current plan 10 of 53: 13-10
done on 2026-09-26, 13-11 next"; until 13-10 it read "Current plan 9 of 53: 13-09
done on 2026-09-25, 13-10 next"; until 13-09 it read "Current plan 8 of 53: 13-08
done on 2026-09-25, 13-09 next"; until 13-08 it read "Current plan 7 of 53: 13-07
done on 2026-09-25, 13-08 next"; until 13-07 it read "Current plan 6 of 53: 13-06
done on 2026-09-25, 13-07 next"; until 13-06 it read "Current plan 2 of 53: 13-02
done on 2026-09-25, 13-03 next", which 13-03 to 13-05 had left as it was.

**13-11, 2026-09-26, on branch `13-11-answer-buttons-in-the-reader`.** A message whose
invitation can be answered has three native buttons, A&ccept, &Tentative and &Decline:
in the text reader's tab after the bar and before the message, in the formatted window
after the page and before the attachments. Each is named for its answer and described by
`what_pressing_it_will_do`, and Alt+C, Alt+T and Alt+D press them, through the panel's
dialog manager in the reader and the page's listener in the formatted window. An
invitation that cannot be answered has no buttons and the reason in the bar above the
signature. The message list's context menu offers the three answers on a message with a
calendar part, on I, E and L. `application::answering::the_answer_buttons` decides it and
`reading_a_message::answer_buttons_for` asks it as part of what is said about a message.
Answering takes the message row it was pressed on through
`answered_meetings::the_invitation_on`; the calendar keeps the answer given in an additive
`answered_with` column; the reply is threaded under the invitation; each outcome is said
once. Ledger 155 updated, 634 opened.

**13-10, 2026-09-26, on branch `13-10-invitation-said-before-body`.** A message carrying
a meeting says what it is at the top of the bar and again at the top of the message, in the
text reader, the formatted window and the preview: the title, the whole date and hours, the
place and the organiser, then whether it is new to the calendar, a change to the meeting
there and when it was, a version answered here, or one already on the calendar. A
cancellation, an answer to your meeting and a calendar file each say what they are, and the
calendar part's row says the same. `application::invitations::what_the_invitation_says`
decides it and `reading_a_message` asks it as the fourth thing said about a message; the
fold is pgp, envelope, invitation, signature. An `application/ics` part is found. The
download of everything keeps each part's name and the calendar document. Finished by a
second executor after the first stalled with the documents commit in progress. Ledger 630
to 633 opened.

**13-09, 2026-09-25, on branch `13-09-undo-in-the-other-modules`.** In Contacts,
Calendar, Reminders, Tasks and Notes, Edit, Undo (`Ctrl+Z`) takes back the last Mark Done
or Not Done, Pin or Unpin, Delete, Move to or Copy to, and Redo does it again, the item
named on the menu. It is one step with the message list, and Undo in a list whose module
did not take it says where it was taken. `application::undoing` decides from what the
store says about the item now; `data::message_cache::taking_back` puts a deleted item back
with its row and drops its owed deletion note in one transaction, the one path
`application::deletions` now names as allowed to, and makes one the account has taken
again as new. Each of the window's four syncs of items counts itself under way
(`ASyncUnderWay`), and an undo refuses meanwhile. A delete's question now says Undo
brings it back. #47 closed. Ledger 627 to 629 opened.

**13-08, 2026-09-25, on branch `13-08-undo-a-move-delete-or-copy`.** With the message list
focused, Edit, Undo (`Ctrl+Z`) takes back the last move, delete or copy, and Redo does it
again. `application::undoing` decides each message from what the store says about its row
now: a change still waiting for its server is ended here through `undo_here` and nothing
is sent; one the server carried out is moved back through `complete_here_then_tell_the_server`,
the way the action went; an undone copy goes to the trash, never outright; a POP delete
moves back between local folders; and a Delete Permanently the server has, a move to
another account, a row the server moved and this computer dropped, and a change being told
to the server at that moment are refused in a sentence naming the message. Each replay of
waiting changes now counts itself while it runs (`APushUnderWay`), since nothing else on
the interface thread could see one. GAP-02's `[D]` line and box ticked. Ledger 624 to 626
opened.

**13-07, 2026-09-25, on branch `13-07-undo-a-mark-star-or-label`.** With the message list
focused, Edit, Undo (`Ctrl+Z`) takes back the last Mark as Read or Unread, Star or Unstar,
label put on or taken off, or Remove every label, each message back to its own state
before, and Redo does it again. `application::undoing` decides what changes and names it,
"Undo Mark as Read: Quarterly report" or the count; the window remembers the action once
after the writes, puts each mark back through the cache write and `spawn_server_change`
the action used, and says one sentence. One step, no timer; the mark after the reading
wait never replaces it. Undo's help says it is experimental. Also, as ledger 621's first
half: a dialog's `Ctrl+Z` and `Ctrl+Y` with nothing to do say the Edit menu's sentences.
Ledger 622 and 623 opened, 621 narrowed.

**13-06, 2026-09-25, on branch `13-06-undo-in-every-dialog`.** Every box a person types
into in a dialog keeps the history 13-05 built, through `keep_a_history` over a small
`TextBox` trait a text box and an editable combo box both meet: the composer's address and
subject lines and Check Spelling, the account editor, Add Address Book and Add Calendar,
the contact editor with its Prefix and Suffix combo boxes, the item form, the rules, labels
and signatures, Send Feedback, Settings' download folder, and the search and title dialogs.
A password box keeps none. A value a dialog opens holding is where its history starts,
bound after the prefill or written with `set_anew`. `tests/every_text_box_keeps_a_history.rs`
holds every `TextCtrl` and `ComboBox` builder under `src/presentation` to the history; the
number fields and wxWidgets' two text-entry dialogs keep Windows' step, named with the
reason (ledger 621). Ledger 620 and 621 opened.

**13-02, 2026-09-25, on branch `13-02-print-layout`.** `application::printing` turns the
reader's own composition, handed `on_paper(out)` so every date is written in full, into
pages: the warning first, the header block kept on one page, every line wrapped at the last
space that fits by a measuring function the transport will hand in, each page stamped
"Wixen Mail, <title>, page N of M" with no dash. The job is named by kind alone. The five
items' `fields` are one list their `read_full` joins and `from_item` prints one to a line,
the long text as written; the 51 spoken readings in `read_aloud.rs` are unchanged. 18 cases
in `application::printing`. Nothing reaches it until 13-03 wires File, Print; ledger 612
says so. The plan before this:

**13-01, 2026-09-24, on branch `13-01-undo-redo`.** The main window's Edit menu opens with
Undo (`Ctrl+Z`, U) and Redo (`Ctrl+Y`, R), acting on the note title, the note body and the
contacts search through the box's own one step, greyed while a menu is open when there is
nothing to do and offered again as it closes so the keys always speak; Cut made one step the
box can undo, since `replace` left Undo nothing to put back; Undo Send third, still on
`Ctrl+Shift+Z`, its letter moved from U to N. `tests/undo_reaches_the_text.rs`, 15 tests,
reads it on a real box and the real menu bar. Ledger 610 (the tester's ear) and 611 (Mark
Done and Pin greyed by module swallow their keys) opened. The plan before this:

**Phase 13 planned 2026-09-24 against `main` at `630e2a67`**, after Pratik confirmed the
order inside it that day and said to plan and implement it. Fifty-three plans in
`.planning/phases/13-new-features-most-from-the-outlook-gap-audit/`, one per wave from 1 to
53, because every plan writes `guards/guards.toml` and `.planning/WINDOWS.md`: keyboard
basics (13-01 to 13-09), reading mail (13-10 to 13-21 with 13-17.1, keys locked with a
passphrase, added by its planner), provider features with the runner inside them (13-22 to
13-36, 13-24.1 split from 13-24 at its task boundary), the automation (13-37 to 13-44),
import and export (13-45 to 13-50), and the close (13-51), which runs `scripts/check.sh all`
once by hand before its merge. The README carries the plan table, the order and its
reasons, fifty-one decisions taken that day for Pratik to overrule, the four answers that
wait on him ((a) `cfb` 0.15.0 at 13-47, (b) three `windows` features at 13-03 and `rand`
0.8 renamed at 13-20, (c) Graph's People.Read and the tasks permission at 13-28, (d) the
wxDragon printing issue upstream, ledgered and never posted), the collisions, and what the
tree contradicted in the research. The integration moved 13-37 to 13-51 two waves later so
no two plans share one, pointed 13-40, 13-42, 13-43 and 13-44 at 13-24.1's runner, and
named 13-17.1 in 13-51's `depends_on`. `main` was pushed at `630e2a67`
(`git log origin/main -1` the same day); the commit landing these plans is on `main` and
not pushed. `REQUIREMENTS.md` names each GAP requirement's plans.

Until phase 13 was planned, the paragraph below was the current one, and its first line
named phase 12 (The editors, and what the alpha still owes) and "Current plan 16 of 16":
12-01, 12-02,
12-02.1, 12-03, 12-03.1, 12-03.2, 12-04, 12-05, 12-06, 12-06.1, 12-07, 12-08, 12-09, 12-10,
12-11 and 12-12 complete, and the phase's full gate green at `566116d3`: **phase 12 is
complete**, and phase 13 is planned next. After 12-12's documents commit this line read
"the phase's full gate, 12-12's task 3, next". After 12-11 this line read "Current plan 15 of 16 ... 12-12
next". After 12-10 this line read
"Current plan 14 of 16 ... 12-11 next". After 12-09 this line read "Current plan 13 of
16 ... 12-10 next". After 12-08 this line read "Current plan 12 of 16 ...
12-09 next". After 12-07 this line read "Current plan 11 of 16 ... 12-08
next". After 12-06.1 this line read "Current plan 10 of 16 ... 12-07 next".
Until 2026-09-23, after 12-04, this line read "Current plan 5 of 15 ... 12-03.2 next,
then 12-04", which 12-03.2 had left as it was; after 12-05 it read "Current plan 7 of 15 ...
12-05 next"; after 12-06 it read "Current plan 8 of 15 ... 12-06 next"; after 12-06.1 was
inserted it read "Current plan 9 of 16 ... 12-06.1 next".
...
interval (1 to 60), Font size (8 to 72) and Default reminder (0 to 1440) are spin controls
holding their own ranges; Mark as read after is Immediately, After a number of seconds, or
Never, with a seconds spin control (1 to 600) reachable only while a wait is chosen. Page Up
and Page Down do nothing in a spin control, measured. **The typing field's name does not
reach the running program.** `names::name_the_spin_control` gives the buddy from
...
**12-05 complete 2026-09-23**, on branch `plan-12-05-send-feedback` from `main` at
`254a067a`, pushed with a pull request; the merge commit and the pull request's runs are in
the report that closes it. Send Feedback opens from Help, `Ctrl+Shift+F` and About's new
button: a category first, the questions that fit it, five boxes each saying what they send
with the version and the redacted log excerpt ticked, and the exact message shown before
Send. Send keeps a copy under `logs\feedback` and queues the report from the default account
through `put_in_the_outbox`, the row function the composer now shares, to support@wixen.app,
or for a security concern to security@wixen.app with the excerpt unticked, a bare subject
and GitHub's private reporting page beside Send. ALPHA-02 ticked; ledger 589 (the ear), 590
(the two mailboxes) and 591 (the Help menu's doubled letters) opened.

**12-04 complete 2026-09-23**, on branch `the-about-dialog-names-its-owners` from `main` at
`c546707a`, pushed with a pull request under Pratik's standing OK; the merge commit and the
pull request's runs are in the report that closes it. About reads its words from
`application::about`, names Pratik Patel and the Wixen Project with other contributors under
the MIT licence in step with `LICENSE` and the executable's file properties, keeps the full
version, and offers wixen.app and wixen.app/support as native links, chosen by a reading over
MSAA, consumed in their handler and opened through `safe_external_url`. ALPHA-01 ticked;
ledger 587 (the ear) and 588 (the site) opened.

**12-03.1 complete 2026-09-23**, on branch `the-window-gives-the-page-the-keyboard-back`
from `main` at `342b019f`, pushed with a pull request on Pratik's standing word of
2026-09-23, to be merged once its CI, NVDA and Accessibility runs are green; the merge
commit and the runs are in the report that closes it, since a summary committed before the
merge cannot quote them.
The formatted window gives the keyboard to the page when it comes back with it on its frame
or on nothing (`presentation::page_focus`), red first on wx's frame-saved path; the link case
records the window's own thread after each return; and
`tests/the_nvda_cases_wait_for_words_the_program_says.rs` holds every text an NVDA case waits
for to the one place in `src` that says it, red on the four stale texts, with the calendar
and filter cases corrected. FOUND-22 ticked, FOUND-20 corrected by dating, ledger 576 to 580.
...
**Answered later on 2026-09-23, all four:** a red full gate at the phase's close is fixed on
12-12's own branch as a small red and green pair; each shell suite runs only for its own
inputs, which 12-03.2's task 3 builds; no pushes beyond his standing OK, under which plans that
change what is spoken or shown push their branch and open a pull request and others do not;
and ledger 373 closes as built, in 12-03.2's task 5.
...
every push of `main` after it is his word again ("of `main`" added later on 2026-09-23: a plan's
branch is pushed with a pull request under his standing OK of that day when the plan changes
what is spoken or shown, and not otherwise), and the runs that push started are the first verdict
...
worked examples. A guard measurement that does not return costs one record and not a shard
now: `scripts/guards.py` holds every record, and every suite's pre-read, to one wall clock
shared by its build and its run, kills what passes it along with the processes cargo
started under it, reports it unmeasured with the seconds it reached and which term it was
in, and goes on to the next record or suite; the closing line counts what a run gave up on
and the run exits 1. The default is 1,800 s, just under four times the 456 s the longest
record of run 35520204784 took. The restore on the give-up path was proved by hand twice,
once expiring in a build and once mid-suite, and the plan's own reading for the first could
not have proved it: with `--time-limit 1` the budget expires in the per-suite pre-read that
the same task bounded, before any break is applied.

All 26 records the sweep did not find in agreement were measured again here. Three that
reddened nothing came out with three different causes: the divs record is retired, because
the stripping it guards is redundant wherever a div holds a block and cuts a line at every
inline element where it does not, so a test asserting what it now does would write a defect
down as a rule; the provenance record's break moved off a document onto the reading's own
`names_a_target`, because no line in the tree has that word as the only excuse for a figure
the reading matches; and the move window's test was the fault, not the record, because
`move_or_copy_message` calls `owner_of` twice and a `contains` over the body was answered
by the second call. Two that a runner cannot judge now say so on themselves, with both runs
that found them green there. Five breaks the tree could no longer take were rewritten, one
split in two, with the commit that moved each named by `git log -S` read as a pair. Ten of
the fifteen short records gained 29 names, every one in a file the record had never named;
the other five were never short, because one test that fails on GitHub's runners under any
break was the single unnamed red for all five. Shard 40's nine cost 33 minutes here against
six hours of runner time that produced eleven verdicts and lost the shard: eight agree, and
the ninth does not return when broken, which was the limit's first unsupervised use and is
left without a verdict rather than with a guessed one.

`scripts/check.sh all` passed on the branch in 474 s, 8,672 tests. The register holds 1,035
records, census 797 swept and 238 since. The ledger is at 573 with 536 open and 37 fixed.
`FOUND-21`'s seven `[D]` lines are ticked and its `[S]` line, the next sweep, is untouched.

**12-01 merged 2026-09-22 at `e29c514b`.** On branch
`the-nvda-case-comes-back-the-way-a-person-does` from `main` at `c31ca43f`, three commits and
the merge. The product was not at fault, and that is measured rather than argued: the
formatted message window gives the keyboard back to the browser every time it is activated,
`Chrome_WidgetWin_1` inside the window after the first activation and again after a
deactivation that takes the keyboard away, so `wxTopLevelWindowMSW::OnActivate`,
`DoRestoreLastFocus` and `wxWebViewEdge::OnSetFocus` hold on this tree, no activation handler
was added, and nothing a person can see changed. NVDA run 35520201976 failed on the case's
second `K` because the case trusted `AppActivate`'s answer, which means a window was found and
asked for and not that it came to the front. The case now presses Alt+Tab, waits for Windows
to name the page window as the window in front, falls back to `activateWindow` once and
records which worked, and writes the foreground and the UI Automation focused element down
before every key; `nvda-tests/README.md` says why an activation call's answer is not evidence.
FOUND-20 is ticked on both its `[D]` lines with its own evidence line corrected, and ledger
567 carries the run. One guard record, measured at 1 red. The corrected case runs nowhere on
this machine; its green is the next push of `main`, which is Pratik's. Next: 12-02, the
separate window, #80's second half.

**Phase 12 planned 2026-09-20 against `main` at `0ad66e48`.** Twelve plans in
`.planning/phases/12-the-editors-and-what-the-alpha-still-owes/`, one per wave, with the
README carrying the plan table, the order and its reasons, eighteen decisions each
overrulable in a summary, the table of what the tree contradicted in the issues and the brief,
the record and test counts every plan is written around, and the eleven decisions that are
Pratik's. 11-11.2 and 11-13 became 12-02 and 12-03 by `git mv`, their frontmatter changed and
their premises re-taken against `0ad66e48` under a heading above the original readings, so
phase 11's directory holds 29 plans and 29 summaries, its row reads `29/29` and its roadmap
line is ticked with the move dated. Phases 13 and 14 have roadmap entries, goals, criteria
and requirements and no plans and no progress row, because a row needs a directory on disk
and a plan written now would rot against a tree phase 12 changes. `REQUIREMENTS.md` holds
119 requirements by its own count. Nothing pushed; `main` was already pushed
(`origin/main..HEAD` is 0 before this commit), and the NVDA run on that push is red on the
case 12-01 fixes.

**11-12 merged 2026-09-20 at `9ee0e9a8`, and the phase closed.** The closing read, documents
and planning files only, on branch `the-pages-say-what-the-list-does-now` from `main` at
`1993b56e`. The alpha page's short version says what the list, the reader, the composer and
the settings gained between 2026-09-18 and 2026-09-20 and that none of it has been heard,
its known-missing list holds one entry per plan's unheard sentence and what would help most
gains three items; the listening page holds items 58 to 83, one per ledger entry 533 to
565; the guide, the shortcuts page and the changelog say the separate window is a later
build, dated, and the guide says the program's own two sentences still say the next build
(ledger 566); the guide's shortcut list stops naming `S`, `N` and `P`, never bound; four
pages that said the library blocks Gmail's conversation id, false since 11-08.1, are
corrected by dating. Every test the twenty-eight coverage blocks name was checked to exist
in its file, 449 found and the one not found traced to 11-05.1's split; twenty-four LIST
ticks stand, LIST-02 stays open on its two size rows (537), LIST-11 and LIST-19 stay open
on the deferrals; the roadmap's thirty-one criteria carry their dated closing sentences,
the plan list ticks 11-12 and leaves 11-11.2 and 11-13 with the deferral dated, the
progress row reads `29/31` closed with two deferred, and the phase line at the top stays
unticked with the reason, since it stands for a plan list two of whose plans have not run.
**Two plans did not run and will not run in this phase: 11-11.2 (the separate window as a
process of its own, #80's second half, criterion 22's last clause, LIST-19) and 11-13 (the
status bar's sentences read in one pass, #75, criterion 14, LIST-11), deferred to the front
of the next phase on Pratik's decision of 2026-09-20 under his token budget.** The whole
gate was green on the branch on its first run, 8,651 passed and none failed, 455 s, the
same count as 11-11.3's since no test changed. Nothing pushed; `main` is 213 commits ahead
before the commit that lands the summary, and Pratik pushes once the phase is done, which
it now is. The next planner starts with the two deferred plans and then group 5 from the
README's table.

**11-11.3 merged 2026-09-20 at `6e23656b`.** #79 closed: a Markdown block marker typed with
its space counts at the start of any line of the message, where since 2026-07-29 the page
refused one on any line after a line break, every line of a reply to plain text, a line
after Shift+Enter and the line after Enter on the empty first line, before reading it and
with nothing said; `startsItsLine` asks the line, a `<br>` or a block before the node, in
place of the sibling guard. A refusal that met a marker is posted and written to the log at
debug through `BlockMarkerRefused(WhyAMarkerWasRefused)`, never announced. The first
character typed after a closing star, underscore or backtick is taken back out of the style
with `removeFormat`, one mechanism for every tag after the plan's toggle was measured to
leave a code span out. The reading types into the real compose page in the hosted WebView
with posted keys, each waited for through the page's own `input` event after three runs in
ten lost characters posted one per tick, and holds twelve steps. The pages say type the
marker, then a space, in words, and the guide lists the markers for the first time. Two
records new, the count check's re-measured. Ledger 565 for the tester's ear. 11-11.2 is
deferred to the next phase on Pratik's decision of 2026-09-20 under his token budget; the
dependency was wave ordering only. 11-13 is next.

**11-11.1.3 merged 2026-09-20 at `1e39650a`.** #92, second half, closed: All Inboxes keeps a
view of its own under its own row identity, the key the tree state and the landing already
used, switched with Ctrl+T, read at the landing through Show conversations by default and
settled before the mail is asked for through the one function every landing and the saved
search's arrival now use, so the check mark says the view of what is on screen everywhere.
Every inbox's conversations are one row per account and conversation through the one-folder
scope as one text with four parts replaced; each row carries `read_in`, and the set, the
fetch, the tree, the count and the switch-back read it, the last found on the branch by
reading the D-11 helper. The every-inbox query costs 107 ms beside `unified_inbox`'s 18 ms
on 16,000 rows over two accounts, after a first draft whose membership clause correlated on
the row's account cost 198 s and only the plan's measurement caught it. Six records new, nine
corrected by hand, six of them stale from 11-07.1, 11-07.2 and 11-08.1 in modules no record
named. Ledger 563 for the tester's ear and 564 for the arrival gap older than the plan.
11-11.2 is next.

**11-11.1.2 merged 2026-09-20 at `ae0fa4d2`.** #92, first half: a folder nobody has set shows
conversations, as Show conversations by default on the Reading tab beside Default sort order,
on unless turned off, by Pratik's decision and his amendment. `Showing::from_stored` takes what
a folder never set shows and keeps a stored nought flat, so a folder chosen flat stays flat;
`what_a_folder_never_set_shows` reads the setting once per landing, never in the startup
block (11-11.1.1's audit at 20) and never per row; the check box after Then by is named with
its own words on both channels and OK writes it back, proved by clearing the real control in
the settings target, which needed the click notification as well as `BM_SETCHECK` because
wxWidgets keeps a check box's state itself. The guide has no Settings section with Reading
rows, so the Thread View section names the setting. Four records new, twelve re-measured.
Ledger 562 for the tester's ear. 11-11.1.3 is next, and hands `what_a_folder_never_set_shows()`
in at the All Inboxes landing, which the settings target's reading already requires of every
`from_stored` call in the window.

**11-11.1.1 merged 2026-09-20 at `051c3529`.** #91: the timer's closure captured Mark as read
after at startup and the date settings were captured the same way at ten sites, so a save
changed nothing they held. Both are in `WxUIState` now, written at startup and by
`MarkReadAfterChanged` and `DateSettingsChanged`, and the audit in
`tests/a_setting_saved_applies_without_a_restart.rs` holds every setting the startup block
reads to a list with a disposition each. The log level and the default sort order say under
their controls that they take effect at the next start. The layout's disposition is the
window's own, not the plan's "offered by no control": Then by writes its second level and
`the_sort_as` reads it on use. Ledger 561 for the tester's ear. 11-11.1.2 is next.

**11-11.1.2 and 11-11.1.3 written 2026-09-20 against `4a09bfc2` while
11-11.1 executed, re-read against `390a580c` with it merged, and
committed after it.** #92 (Pratik's decisions of that day: Thread View on
by default, and All Inboxes with a view of its own instead of inheriting
the last folder's) is two plans after 11-11.1.1 and before 11-11.2,
because his amendment the same day made the default a setting on the
Reading tab, "Show conversations by default", and that half is a screen
control with two guards and the older-file test, while the other half is
a cache query and a field on the conversation row. 11-11.1.2:
`Showing::from_stored` takes the answer for a folder never set from the
setting, read at the landing and never captured at startup (11-11.1.1's
audit reading holds that); a stored nought still means flat; the box
beside Default sort order; the field, its first reader (the landing, in
a file that acts, since the read-by-something guard skips the settings
screen) and the box one green, which is what 11-11.1's summary found for
its handlers; the D-09 sentences dated. 11-11.1.3: the view under All
Inboxes' own row identity in `tree_state`, the key the collapsed state
and the landing already use (the sort has no per-row key, which corrects
the issue's words); Ctrl+T there; the check mark synced at every landing
and the saved search's arrival; `conversations_in_every_inbox` grouped by
account and thread id with `read_in` on every row, so a conversation in
two accounts is two rows and each act reaches its own account; a label
and a saved search stay one row per message with a sentence saying so.
What the tester saw was worse than said: All Inboxes drew the previous
folder's conversation rows under its own title. Mail arriving while All
Inboxes is open refreshes nothing today in either view, older than #92
and ledgered by 11-11.1.3. LIST-27, criterion 31, 95 requirements with
LIST-26; the waves from 11-11.2 on moved three in all; `total_plans` 158
from the disk. The current plan stays where 11-11.1's summary put it;
11-11.1.1 is next.

**11-11.1.1 written 2026-09-20 against `4a09bfc2` while 11-11.1 executed,
re-read against `390a580c` with it merged, and committed after it.** #91
(Mark as read after does nothing however it is set, confirmed after a
restart) is 11-11.1.1 after 11-11.1 and before 11-11.1.2. The main timer
asks the rule with a value read once at startup and captured by its
closure (`wx_app.rs:1294`, `:6034`), and the Settings-saved arm sends the
working day, the alert lead and the calendar view and nothing for this.
The plan puts the setting in `WxUIState`, written at startup and by a new
update the arm sends, and the timer reads the state; the four date
settings, captured at `:1260` into the row, cell and read-aloud closures
while four other sites read them on use, go the same way. Every capture
in the startup block was read against the code: nine bindings, three
following the arm already, three into the state already, the two above
now, and the layout's sort by design; the log level is initialised once
with no reload; 11-11.1's `open_links_in` is read at the route; so the
default sort order and the log level get "Takes effect the next time
Wixen Mail starts" on their controls, and a reading holds the block to an
allowlist with a disposition each so a new capture fails. The issue's
line numbers were the 11-11.1 branch's and are `main`'s now. LIST-26,
criterion 30.

**11-11.1 merged 2026-09-20 at `8340e5e6`, on branch
`a-link-opens-where-the-setting-says` from `main` at `4a09bfc2`.** Where a
link opens is a setting, the link caught in the page, the menu on both
surfaces (#80, first half). The probe found and measured why the tester's
Enter opened a link inside the window against two vetoes written to hand
it to the browser: wxWidgets keeps a navigating event's address in
`GetURL`, wxdragon 0.9.17 hands `WebViewEventData` only the command
string, which is empty for it, and the vetoes' guard `!url.is_empty()`
skipped every link on both surfaces since they were written; measured in
`tests/a_link_opens_where_the_setting_says.rs` against a built browser
control, one navigating event after the click carrying `Some("")` for
the main frame and the control following the link, three runs of three.
`application::opening_links`: `Where` (browser, message view, separate
window), `Asked`, `Route`, `route` as one pure function with every cell
held, the sentences. `presentation::page_links`: the click listener with
`preventDefault` posting the address with Ctrl and Shift as the browser
and the separate window, Backspace and Alt+Left posting the way back, the
reader. `open_links_in` on the Reading tab after Open messages with the
sentence under it, an absent key the browser through a default function.
`wx_app.rs`: `PageHost` as what both surfaces are; `follow_the_link_the_page_posted`
with the sanitiser before the route; the message view route with
"Opening <host>", the title said once and the page window entitled, the
failure said in words with the message brought back, Backspace bringing
the message back; the link's menu on the preview and on the formatted
window, which had none, through `the_links_menu` and
`answer_the_links_menu`; the vetoes one second line keyed on the main
frame and the window's loading; Save Link As on S, a clash with Select
All the letter guard could not see until the menu was one function; the
`page` scan target on a two-message conversation and the NVDA case.
Five records measured; ledger 560; three deferred items; the privacy
page's Where a link opens and its pictures section corrected; #80
commented with the finding and the ear list, left open for 11-11.2. The
tree contradicted the plan on the veto (it fires and vetoes nothing), the
page window's missing menu, the A clash, `serde(default)` on a String,
a made link needing a plain body, `wx_settings.rs` at 21 records, and
the two acceptance greps that count elsewhere. 199 tests in `wx_app.rs`
before and after.

**11-11.0 merged 2026-09-20 at `fab0ecea`, on branch
`what-the-sender-hid-is-not-read` from `main` at `262e4e3f`.** What the
sender hid is not read, a layout table is not a table, the page's own
markup said once (#90). `application::hidden_text` holds the six hiding
rules as one match over a declaration's property and value (`display:none`,
`visibility:hidden`, `font-size:0` in any unit, `max-height:0` only with
`overflow:hidden`, `mso-hide:all`, `aria-hidden="true"`; `opacity:0` alone
never), the seven filler characters with `strip_filler` borrowing when
nothing is stripped, what a dropped block held (nothing, a preheader of at
most 200 characters before any visible text, words), the sentence in the
pictures' register, `keeps_its_label` (a link or a button, a table without
the layout claim), `keep_the_layout_claim` for both cleaners, and
`drop_what_the_sender_hid` as one scraper walk that detaches, strips,
unlabels and serialises, handing an ordinary message on byte for byte. The
renderer runs the drop first in `sanitize_and_count_held_back`, which
answers `(String, LeftOut)`, the pictures' counts and the blocks' count
together, and the one `held-back-count` paragraph holds up to three
sentences; `sanitize_html` is untouched, since the reply editor and the
editor's body go through it; the cleaner keeps `presentation` on a table's
four tags and no other role, and admits `aria-label` on `a` and `table`
for what the walk left; a single message's heading is "Message from" with
no number. `long_text::read_markup` drops what the sender hid for speech
and not for editing, takes the layout claim from the same rule, reads a
layout table as its blocks in order and never as a Table piece, walks a
`div` holding blocks as blocks, gives a block met inside inline content a
space either side and collapses a cell's spacing, so the newsletter's four
joins of ledger 555 are apart; `snippet.rs` reads the one filler set. The
tester's Substack newsletter is `tests/fixtures/issue_90_substack_newsletter.html`,
91,980 bytes, the saved body byte for byte apart from thirty addresses
replaced by hand (fifteen redirect links, nine app links, three open-in-app
links, three beacons, each carrying the recipient's token), with Pratik's
leave at its head; `tests/what_the_sender_hid_is_not_read.rs` holds 19
cases over it. Six records new and one rewritten twice, each measured on
the green tree under `WIXEN_MAIL_DATA` on an empty folder, every one
exactly the red it names; 1,006 records, census 798 + 208; no test added
to `html_renderer.rs` (92, 10 records) or `long_text.rs` (60, 20);
`wx_app.rs` untouched at 196 attributes and 100 records. The guide's
section What the formatted view leaves out, the privacy page's paragraph
Text a sender hid, the changelog's entry; ledger 555 fixed and 559
recorded (unrun-verify, the ear); the text reader's numbering of one
message deferred with its reason. What the tree contradicted: the saved
body carries two carriage returns a line (102,542 bytes, not 101,756);
three pictures a pixel square, not two; thirty addresses named the
recipient, not twenty; `sanitize_html` is the sending path rather than
`WhoseMessage`; a `div` holding blocks had to be walked as blocks for the
structure to follow the words. The drop's cost on the fixture: median
11.6 to 12.1 ms over ten runs, debug profile, 2026-09-20. #90 closed from
the merge with the ear list. LIST-25 ticked on its `[D]` line, amended.
8,571 tests on the gate, 421 s on its first run; `main`'s hook 435 s,
green on its first. `completed_plans` 150 counted from the `*-SUMMARY.md`
files on disk. 11-11.1 is next.

**11-11 merged 2026-09-20 at `f497785f`, on branch
`pictures-shown-by-default` from `main` at `5c87bd4c`.** Pictures shown by
default, beacons held back, the privacy page's tracking section (#28,
#29). `hold_back_remote_pictures` is off by default, the serde and struct
defaults both, with the older-file test moved to assert the absent key
answers no; a file that carries the key keeps its answer and the tester's
carries false already. `application::describing_pictures` holds
`UndescribedPicture`: Nothing, Image, Photo, with labels in plain words,
stored words, a garbled value read as nothing because a word written for a
broken file would be a description this program invented, and
`from_stored_settings` for the note reader. `pictures.rs` gains
`looks_like_a_beacon` (a declared width or height of a pixel or less,
digits with or without px, nothing else, and its doc says how it differs
from `could_be_furniture`), `is_marked_decorative`, `what_to_do_about_a_tag`
over the cleaner's tag with the beacon asked before the mark,
`the_links_text_as_a_description` (one picture in the anchor, no alt of
its own, some words, stripped and escaped), `describe_the_undescribed`,
and `HeldBack` with two counts for the sentence at the top. The renderer
reads the third answer with its two, runs the three rules in
`hold_back_what_would_be_fetched` in the one order that is right (the
link's words, then each tag, then the undescribed rule last so its empty
description never reaches the decorative rewrite), a beacon leaving an
empty span and counted, a decorative remote picture said or passed over
by `announce_decorative_pictures` and counted by neither; `sanitize_html`
calls none of the three, held as a case and as a source reading.
`long_text::spoken` reads the choice from the stored settings and passes a
picture over under nothing, or says the word alone, its one image test
rewritten in place. The Reading tab's choice under the two picture boxes
with the sentence under it; the switch's label says "any picture" and its
description says which way it ships; the sentence on the tab that said
"There is no setting for this yet" under the switch since 2026-08-27 now
says which surfaces fetch. `test_a_tracking_pixel_is_not_fetched`
rewritten to the shipped default with its comment saying which rule
protects now. The two settings guards: the read guard red at the field
and green at the reader, the offered guard green as soon as the stub
control named the field. Five records new (two on `pictures.rs`, one on
`describing_pictures.rs`, one on `html_renderer.rs`'s sending path, one on
`wx_settings.rs`'s read-back, the target named as suite for four), the
composer's constructor record rewritten onto the new shape, the two
`pictures.rs` records re-measured with the target's task 2 cases and each
found one test short by the runner and corrected by hand, the sending-path
record's first draft naming two where the runner named nine; 1,000
records, census 798 + 202; `wx_app.rs` at 199 and 100 records, untouched.
The privacy page's pictures section rewritten with the new default and
its cost, its three stale sentences kept and dated, and the new section
listing every channel with its file, the "never" paragraph the census of
outbound clients re-taken that day (38 places in 14 files, twelve shipping,
two test-only; the plan's `answering.rs` is the loopback test server and
not the meeting-reply sender); the `rsa` advisory's expiry condition traced
and found not to trip because an opened PGP message is shown as text, said
in `.cargo/audit.toml`; the guide's section; the changelog's entry; ledger
558 (unrun-verify, the reader). #28 and #29 closed from the merge with the
ear lists. LIST-09 and LIST-10 ticked on their `[D]` lines, amended.
8,523 tests on the gate, 419 s on its first run; `main`'s hook 420 s,
green on its first. `completed_plans` 149 counted from the `*-SUMMARY.md`
files on disk. 11-11.0 is next.

**11-10.1 merged 2026-09-19 at `be97ed86`, on branch
`an-address-written-out-is-a-link` from `main` at `1d5bc2ae`.** An
address written out is a link (#89). `application::links_in_text` with
`addresses_in`, `as_html` and `spoken`: word by word, the brackets and
quotes that open a word and the punctuation that closes it left outside, a
closing bracket the address's own only when it opened it as the composer's
rule has it, `is_an_address` the one shape rule the snippet now asks
rather than keeping a copy, every href through `safe_external_url` and a
refused address left as text, `www.` followed as `https://` and a bare
mail address as `mailto:`, the host said for the ear with `www.` and the
port off and a mail address whole. The renderer's two plain branches are
one `plain_text_as_a_page` through the markup, the composer's
`escaped_plain_text` goes through it, `as_markup` links the parser's text
events outside a code block, a link and a picture, and `spoken` says the
host in the passage returned as written and in every piece. `tel:` in
`SAFE_URL_SCHEMES` with an empty one refused; the cleaner found already
admitting `tel:`, `sms:` and twenty more and dropping `javascript:` on its
own, which the plan did not know, so the note is
`say_which_links_are_not_opened_here`, a pass over the cleaned markup on
the reading path asking the gate of every href the cleaner kept, a refused
link keeping its words with "(link not opened here: sms)" or "the address"
beside them and nothing on the way out; a `javascript:` link gets no note.
The corpus of eight cases and the gate's `tel:` case in the renderer, 83
to 92 with the count check's remedy run on the green tree; the target's
eleven cases through `wrap_body`, the composer's page, `long_text::spoken`,
`as_markup` and the real cache for the snippet; `long_text.rs` 60 and
`editor_document.rs` 82 as before, one case each side rewritten in place.
Six records new, one rewritten onto the new plain arm, the six naming the
renderer measured again, one of them found blind on this machine because
the profile the tests read holds `announce_decorative_pictures` false and
measured under `WIXEN_MAIL_DATA` on an empty folder with the reason on the
record; 995 records, census 798 + 197; `wx_app.rs` at 199 and 100 records,
untouched. The guide's section, the shortcuts sentence, the changelog's
entry, ledger 557 (unrun-verify, the ear). #89 closed from the merge with
the ear list. LIST-24 ticked on its `[D]` line, amended. 8,489 tests on
the gate, 418 s on its first run; `main`'s hook 422 s, green on its first.
`completed_plans` 148 counted from the `*-SUMMARY.md` files on disk. 11-11
is next.

**11-11.0 written 2026-09-19 against `ced898eb` while 11-10 executed, and
committed in the gap after its merge.** #90 (an HTML message read in the
formatted view repeats phrases and announces groupings) is 11-11.0 after
11-11 and before 11-11.1. Pratik measured the tester's Substack message on
its raw markup: two `display:none` preheader blocks holding the subtitle and
two hundred U+034F joiners, forty-eight of forty-nine tables
`role="presentation"`, one region named "Post header". The plan drops what
the sender hid before the sanitiser by the sender's own rule
(`application::hidden_text`, six rules and the filler characters, each with
a case), with a count said once only for words that were not a preheader;
keeps `role="presentation"` on tables and a sender's `aria-label` only as a
link's or a data table's name; says the subject and the sender once from
the page's own markup; gives the reader's structure the same fixture with
its blocks apart and a presentational table read as blocks (ledger 555);
and keeps the message as a public fixture under `tests/fixtures/` with its
tracking addresses and the recipient's token replaced, by Pratik's leave,
which is the executor's to write from the saved body. Its plan number is the
string `"11.0"` because the bare number is 11-11's. Its premises were read
again at `f92871bb`: the files it cites are the same bytes, and nothing
11-10 changed touches them. LIST-25, criterion 29, 93 requirements; the
waves from 11-11.1 on moved one; `total_plans` 155 from the disk. 11-10.1 is
next, as before.

**11-10 merged 2026-09-19 at `39d53503`, on branch
`a-rule-can-change-how-a-row-is-announced` from `main` at `ced898eb`.** A
rule can change how a row is announced and not only how it is filed (#62).
`FilterAction::SayFirst`, stored as `say_first` with its phrase trimmed and
refused empty or over `SAY_FIRST_LIMIT` (40) where a stored rule is read;
`settle` keeps the last phrase; `carry_out` writes it onto the additive
`messages.says_first` column, every listing carries it into
`MessageListRow` and `MessageItem`, and `virtual_rows::text_for` prefixes
it to the first visible cell under either view, a comma for the pause, or
gives it alone when that cell is empty, never when the Says first column
is itself first. `MessageColumn::SaysFirst` and `Labels` in `ALL` at
seventeen, off in every default layout, each with a message expression and
a conversation expression; the conversation query selects the row
message's phrase and every label on any message once, over `here`, rather
than joining labels in Rust as the plan wrote, so the cell and the sort are
one expression; the listing guard's closed set widened to `tags` for the
Labels sort, its companion planting a read of the bodies table instead;
Says first among the self-describing cells on request, Labels not.
`Event::RuleMatched` with its own tone (1175 Hz, 80 ms), words and key;
`Filtered.matches_with_a_sound` counted one per message per rule carrying
the additive `plays_a_sound` flag, before the outcome is settled; summed
over the check's folders into `WhatArrived`, and the arm signals the event
once after `NewMail` with the count as the detail, the reading holding both
halves of the bound. The rule editor offers Say this first seventh, calls
the value box the phrase under it with H for its letter since F is the
field's and P the pattern's, refuses a missing or over-long phrase at OK,
carries the sound box with S read back into the flag, and the manager's
list says every action in the editor's words. `apply_rules` public for the
target. 20 cases and readings in
`tests/a_rule_can_change_how_a_row_is_announced.rs`, one `wxdragon::main`
among them; `filters.rs` 46 to 49, the count check's remedy run; every
other file rewritten in place; `wx_app.rs` at 199 and 100 records. Six
records new, one rewritten for the changed `text_for`, five census records
measured again, every one as recorded; 989 records, census 798 + 191. The
guide's section, the shortcuts page's table for the dialog, the changelog's
entry, ledger 556 (unrun-verify, the ear). #62 closed from the merge with
the ear list. LIST-08 ticked on its `[D]` lines, amended. 8,440 tests on
the gate, 422 s on its first run; `main`'s hook refused once by the keyring
race of ledger 374 on `a_move_says_what_has_not_been_sent` and green on the
retry, 403 s. `completed_plans` 147 counted from the `*-SUMMARY.md` files on
disk. 11-10.1 is next.

**11-09.2 merged 2026-09-19 at `4d9a41d2`, on branch
`a-snippet-is-the-first-relevant-words` from `main` at `fb437e25`.** A
message row's snippet is the message's first relevant words, chosen by
reading the text, Pratik's decision of 2026-09-18 on #82: the rules live
in `application::snippet`, one function and one test each, composed by
`first_relevant_words` in the decision's order. The signature after its
delimiter is left out through `sign_off::split` with the delimiter made
exact first; quoted lines are left out; addresses are dropped altogether,
a web address by its scheme or `www.`, a `mailto:`, a bare `name@host.tld`,
the brackets round one going with it and a sentence end after it moved
onto the word before; a line with no alphanumeric character is skipped,
which is a run of dashes, a bullet, punctuation alone and a hidden
preheader's padding; a line holding one of the marketing openers is
skipped; a bare greeting is skipped when a line with words follows; the
first sentences are taken up to 200 characters, ending at the last
sentence end inside the limit with a word before and a space after, and
at a word boundary otherwise; when nothing survives, the first line with a
word once its addresses are gone, then the first non-empty line as
written. Two rules beyond the decision, said in the module doc, from a
Substack message in the tester's mail: the invisible characters a hidden
preheader is padded with are dropped, and a line repeating the line
before it is said once. A picture is left out only when undescribed,
because the reader writes a described one as its words. `snippet_of` in
`bodies.rs` hands the plain part's lines, or the pieces of
`long_text::pieces_of_markup` one line each with a quote's mark in front
and a table's cells in order, to the one function, for the save and the
pass alike; `words_of_markup` stays for the search index, which the plan's
premise said nothing called. The pass `put_right_the_stored_snippets` runs
over every message with a body row under
`SNIPPETS_ARE_THE_FIRST_RELEVANT_WORDS`, the row the pass of 2026-09-16
wrote left where it is; measured 2026-09-19 over 2,000 short plain bodies
with every row rewritten and reindexed, 752 ms on its own and 740 ms as
the open that carries it. 39 cases in the module, 10 in
`tests/a_snippet_is_the_first_relevant_words.rs` through the real cache
and the listing the window runs; `bodies.rs` 50 and `long_text.rs` 60
unchanged, rewritten in place; two records new on `bodies.rs` with the
target as suite, two rewritten for the new shape and two others naming
the renamed pass case measured again, every one as recorded; 983 records,
census 798 + 185; `wx_app.rs` at 199 and 99 records untouched. The
guide's Snippet column section, the changelog's entry, ledger 554
(unrun-verify, the ear) and 555 (todo, the reader running a layout
table's cell blocks together, found by reading the Substack fixture).
#82 closed from the merge with the ear list. LIST-17 ticked on its `[D]`
line, amended. 8,417 tests on the gate, 413 s on its first run; `main`'s
hook 411 s on its first. `completed_plans` 146 counted from the
`*-SUMMARY.md` files on disk. 11-10 is next.

**11-09.1 merged 2026-09-19 at `517a2a4c`, on branch
`landing-on-an-attachment-says-it-once` from `main` at `fcfe9a15`.** The
Earcon channel is on by default for every event, Pratik's decision of
2026-09-18 on #77, phase 6's reason for the old default kept and dated;
landing on a message with an attachment says the word once, from the row's
Attachment column, since the event's own default is the tone and the status
bar with no words. That default is `FeedbackSettings::the_default_for`, read
wherever no answer was stored for the event, and not an entry a fresh
profile is born holding as the plan wrote it: the tester's stored profile is
`off=` with no per-event group, and the plan's shape would not have reached
him. A profile that stored `off=earcon` keeps its silence.
`Event::text_is_already_on_the_row` marks the one event, and the
never-sound-alone rule falls back to the status bar alone for it, never
speech and never braille, since both ride the one screen reader
notification; the decision's "and braille" is the one clause the tree cannot
carry without speaking the words, said in the summary and the close comment,
one channel added being the overrule. The Feedback tab paints an event
nobody answered for from its own default, with the line beneath still
saying it is the default. The earcon player (#81) opens its output through
`DeviceSinkBuilder::from_default_device` with an error callback that marks
the device gone, and before a sound opens the default device again on that
flag or after `REOPEN_AFTER`, ten seconds, since the later of the last
sound and the last open; the gap over Windows' own notice by a measured open
of 11 ms median and 26 ms worst on this machine (`probe_81_device_open_cost`
in the sweep worktree, twenty opens each way, 2026-09-19). An outage is one
value told once at warn and once on the status bar, "The sounds have
stopped: no audio output device could be opened", through `take_complaint`,
which `signal` and `earcon` show in place of the event's words; a refused
device is asked for again after each gap and not on every sound; the resume
is told once at info; a machine with no device at start is said in the log
only. Three tests that read a fresh `Accessibility` as quiet were rewritten
to switch the sounds by hand, one of them found by the whole gate alone.
15 cases and readings in the new target; `feedback.rs` 49 to 54,
`accessibility.rs` 24 to 25, `config.rs` 68 and `wx_app.rs` 199 unchanged;
six records measured on the green tree and twelve re-measured at the count
check's word; 981 records, census 798 + 183, `wx_app.rs` at 199 and 99
records. Ledger 552 and 553. #77 and #81 closed from the merge with the ear
lists. LIST-13 and LIST-16 ticked on their `[D]` lines, LIST-13's amended.
8,368 tests on the gate, 393 s on its second run; `main`'s hook 405 s on its
second, the first refused by the keyring race of ledger 374.
`completed_plans` 145 counted from the `*-SUMMARY.md` files on disk.
11-09.2 is next.

**11-09 merged 2026-09-19 at `bd5f6929`, on branch
`the-rows-columns-are-read-on-request` from `main` at `39537d13`.** The row
under the cursor is read column by column with its headings on request
(#26): `Ctrl+Shift+;`, and Read the Row's Headings and Text on the Action
menu after Previous Unread, reach `read_the_row_with_its_headings`, which
refuses in words unless the message list holds focus and a row is under the
cursor, gathers the visible layout's cells in its order through
`virtual_rows::text_for`, the function the paint callback answers with, so a
conversation row reads its own cells and what is heard is what is on screen,
composes them through `message_rows::the_row_with_its_headings` and
announces once through `announce_content`, which the mute controls. The rule:
an empty cell left out, a cell whose text already says what its column is
(the six `MessageColumn::heading_is_worth_saying` names) said alone, every
other cell as heading then text, each cell a sentence and one already ending
a sentence not given a second full stop, which the composition case over a
snippet found. The item is on x because every letter of the plan's "Read the
Row's Columns" is claimed on the Action menu by an item or a submenu
appended after `build()`, which the premise's reading of the chain alone
missed; j, q and z are left. The two comments that said the headings are not
being read are corrected: the header before every column but the first is
NVDA's own reading from Document Formatting's Row/column headers, and
nothing an application sets changes it. The shortcuts page gives the three
routes, why the third, and the four steps for a configuration profile
triggered by the current application, with the names read from the guide
that ships with NVDA 2026.3 on this machine on 2026-09-19 (no web here), one
sentence each for JAWS and Narrator claiming nothing heard; the guide's
"Hearing a row's columns with their headings"; the changelog entry. 10 cases
and 4 readings with 3 companions in the new target (17); 41, 43 and 199
unchanged in the three modules; two records measured on the green tree; 975
records, census 798 + 177, `wx_app.rs` at 199 and 98 records,
`message_rows.rs` at 41 and 3. Ledger 550 and 551. #26 closed from the merge
with the ear list. LIST-07 ticked on its `[D]` lines. 8,347 tests on the
gate, 386 s on its first run; `main`'s hook 387 s. `completed_plans` 144
counted from the `*-SUMMARY.md` files on disk.

**11-08.1 merged 2026-09-19 at `76897058`, on branch
`a-conversation-is-gmails-own-and-a-late-parent-joins-it` from `main` at
`c9e46b62`.** A conversation on Gmail is the conversation Gmail shows (#88):
`X-GM-THRID` is asked for where the server advertises the extension, read
into `ImapMessage::gmail_thread_id`, stored as `messages.server_thread_id`
(additive) and made the conversation's name through
`thread_identity::the_conversation_of`, the server's word in front of
`conversation_root`, spelled `gm:<id>` by `the_servers_name`; `rejoin` never
rewrites a name the server gave and takes the server's word as the winner
over the earliest string. The row carries the stored `thread_id`,
`apply_threading` hands it to `ThreadInput::conversation`, and
`thread_messages` names a group by it and never joins two words by the
headers: until now the in-memory pass named a group after its least
Message-ID while `conversation_nodes` looked a row's members up by the stored
name, so the conversation window found them only when the root happened to
sort first, and on Gmail's names never would have. Mail already stored gets
its word once at the next check, after the replay of waiting moves and before
the folder list, through `application::server_thread_ids` over a
`Mailbox::thread_ids_of` seam and the data module of the same name, recorded
per account only when every kept folder answered. The late-parent trace is
six cases in the new target in the download's order, all green on arrival at
task 1's green: the store already joined the late parent, the fuller sibling
and the cut reply, and what task 1 fixed was the naming. 8 cases in
`thread_identity.rs` (39), 3 in `threading.rs` (29), 7 and 5 in the two new
modules, 14 in the target; eight new records measured, one re-measured for
the count check, one rewritten onto the closure the earliest rule moved into;
973 records, census 798 + 175, `wx_app.rs` at 199 and 97 records, `messages.rs`
at 179 and 25, `imap.rs` at 102 and 47. The cost on the scripted server, 31
bytes a message in the header fetch's reply and 54 in the pass's, is a row on
the measurements page. The guide, the privacy page, the changelog, ledger 549.
#88 closed from the merge with the ear list. LIST-23 ticked on its `[D]` line.
8,330 tests on the gate, 384 s on the third run after two refused by the
keyring race (ledger 374); `main`'s hook 412 s. `completed_plans` 143 counted
from the `*-SUMMARY.md` files on disk. 11-09 is next.

**11-08 merged 2026-09-19 at `75c211fe`, on branch
`a-conversation-row-stands-for-one-message` from `main` at `dbbbaa2b`.** A
conversation row stands for one message (#31): the originator when nothing in
it has been read, otherwise the first unread by arrival, and the originator
again when everything is read, chosen in SQL where the columns are by one
ordering, `read ASC, received_at ASC, id ASC`, spelled once in
`the_message_the_row_stands_for!` and read by the Correspondent and Snippet
expressions and by the row's `stands_for` (id, number, sender); the
Correspondent cell says that sender first and everyone else once, and the sort
by Correspondent orders by it. `WxUIState` answers which message a row stands
for under both views, and every reader of the cursor asks it: the cursor
handler previews and fetches the row message and signals a conversation row's
landing from its own count, Space, Reply, the receipts, the invitation, the
save, the read clock, the block and the copy-to-item arm read it, and the body
fetch checks it by id. Landing on a conversation row fetches its missing text,
listed by the cache over the row's own scope with the row message first, as
one chunk through the runner's own bound under the reading gate on the
account's session, one fetch per conversation. Enter hands the conversation
tree the row's message under both views and the tree puts the cursor on it.
The preview under conversation view no longer shows the flat row at the same
index, phase 11's decision 14. The target holds 7 cache cases, 3 behaviour
cases, 6 readings and 3 companions (18); 179, 43, 26, 41, 9 and 50 tests
unchanged in the six modules, two cell tests rewritten in place; five records
measured on the target, the ordering record corrected from six to seven on the
green tree, 11-05.1's lookup record rewritten and measured again; 965 records,
census 798 + 167, `wx_app.rs` at 199 and 95 records. The guide's "Which
message a conversation row is", the changelog entry, ledger 548. #31 closed
from the merge with the ear list. LIST-06 ticked on its `[D]` lines. 8,293
tests on the gate, 379 s; `main`'s hook 399 s. `completed_plans` 142 counted
from the `*-SUMMARY.md` files on disk. 11-08.1 is next.

**11-08.1 and 11-10.1 written 2026-09-19 against `1962e341` while 11-07.2
executed, and committed in the gap after its merge.** #88 (one thread shows
as several on Gmail) is 11-08.1 after 11-08: `X-GM-THRID` asked for where the
server has it and read through `imap-proto`'s own variant, the store's
`conversation_root` and `rejoin` handed the server's id with the server's word
winning, `apply_threading` handed the same id, a once-only pass per Gmail
account for mail already stored, the late-parent, fuller-sibling, cut-reply
and Gmail-id cases traced against the loopback servers newest first with what
the trace finds fixed, subject matching still refused, 11-08's row and count
read back after a re-threading. #89 (an address written out is not a link) is
11-10.1 after 11-10 and before 11-11: `application::links_in_text` recognises
addresses in text, ends before trailing punctuation and an unbalanced bracket,
and makes anchors through `safe_external_url`; used by `wrap_body`'s plain
branch, the reply's quoted text, `as_markup` and `spoken`; the sanitiser read
against the schemes a sender writes, `tel:` allowed, a refused link saying so
beside its words. Both plans' premises were read again at `38ebcb86`: the
files they cite are the same bytes but `mail_sync.rs`'s four comment lines
from 11-07.2, and the counts (960 records, `wx_app.rs` 93 records) are that
head's. LIST-23 and LIST-24, criteria 27 and 28, 92 requirements; the waves
from 11-09 on moved one and from 11-11 on two; `total_plans` 154 from the
disk. 11-08 is next, as before.

**11-07.2 merged 2026-09-19 at `2526b31f`.** A move or a copy to a folder on
another account completes on this computer first as well, Pratik's decision of
the day overruling 11-07.1's decision 29. The crossing is a row in
`moves_waiting` with the other account named in two additive columns, offered
at a check of either account and kept out of the one-server replay, its bytes
in phase 4.1's `moves_in_flight` under the existing ceiling, kept past the
backstop while the row waits and read back with the source side from the
waiting row; `mail_across_accounts` is cut at its two seams into
`fetch_and_keep`, `append_and_ask` and `remove_at_the_source`, the resume over
a held row asking first, the question at start retired with its dialog;
`replay_the_crossings_waiting_for` over an `OpensASession` seam the program
answers with the accounts set up here, done settling the row under the other
account's number, refused undone and said, an append nobody could settle never
a refusal, a message left in both places said; the arms route every set
through one function that builds the kind per message with both gates met,
groups the asks by account and pushes once per account, a message over 25 MB
or of unknown size server first with a sentence; 18 cases in the module (45),
4 in the table (15), 2 in the store (13), `mail_across_accounts.rs` at 43
with three rewritten in place, 11 readings in the target, six records
measured with one corrected by hand from the runner's answer, 960 records,
census 798 + 162, `wx_app.rs` at 199 and 93 records; the privacy page, the
guide and the changelog; ledger 187 dated, 546 amended, 547; #86 closed from
the merge with the ear list, #63 told its crossing proofs are re-taken;
LIST-22 ticked on its `[D]` line, LIST-21's overruled half amended; 8,275
tests on the gate, 366 s; `main`'s hook 373 s. `completed_plans` 141 counted
from the `*-SUMMARY.md` files on disk. 11-08 is next.

**11-07.2 written 2026-09-19 against `15407b1e` while 11-07 executed, and
committed in the gap after its merge, before 11-07.1 runs.** Pratik overruled
11-07.1's decision 29 on #86: a move or a copy to a folder on another account
completes here first as well. The plan cuts `mail_across_accounts`'s crossing at
its two seams into fetch-and-keep, append-and-ask and remove-at-the-source so
a held row resumes it, queues a crossing in 11-07.1's `moves_waiting` with the
bytes in phase 4.1's `moves_in_flight` under its existing 25 MB ceiling rather
than a third store, replays it at a check of either account before that
account's first listing, retires the yes-no question at start, undoes and says
a refusal at either server through `MovePutBack`, and keeps the server-first
path for a message over the ceiling with a sentence saying why. Its premise 5
was rewritten from 11-07's summary after the merge (the set through
`spawn_folder_move`'s worker with `Vec<AMessageMoving>` and the `Chosen`,
`a_set_leaving` landed at once, the cursor handler on `on_item_focused`).
LIST-22, criterion 26, 90 requirements; the waves from 11-08 on moved one;
`total_plans` 152 from the disk. 11-07.1 is next, as before; ledger 187's three
questions and #63's crossing proofs are re-taken after 11-07.2.

**11-07 merged 2026-09-19 at `b35a40cd`.** The message list selects more
than one message: built without `SingleSel`, so Shift with the arrow keys
extends the selection and Ctrl+A selects everything shown up to 5,000, the
bound Select All already had. The cursor is the focused row, and the handler
moved from the selection event to the focus event because a built list showed
the selection event firing once per row of a Select All and not at all when
Shift+Up shrinks the range onto a row it kept. `application::choosing_messages`
decides what a selection holds (each message once, a conversation row
contributing every message of it under a reach per command: Delete the D-07
setting's, Mark as Read, Star and Label the whole conversation, Move and Copy
this folder), the one sentence with the count first, the shown line, the
question a conversation row asks, and the bound read from `editing.rs`, never
written again; 18 cases. Star, Mark as Read under the command and under M, the
Labels, Delete and Delete Permanently, Move to and Copy to read the set off the
control at the key through `chosen_messages`, refuse above the bound with one
sentence, do per message what they did for one and say one sentence; M on one
message row still says the one word; a move or a copy over a set is one worker
with every outcome shown and one sentence spoken at the end; a set leaving the
list lands the cursor once, after the last row, through 11-06.1's rule over
the set's rows remembered in `a_set_leaving`, a refusal ending the wait.
`tests/every_command_acts_on_the_selection.rs` holds the readings and the
built list; the ignored timing gave 75 ms for 5,000 read marks in the cache on
a release build, the row on the measurements page. What the tree contradicted:
32 readers of `selected_message_index`, not 27, 28 after; the two label
sentences for one message went with the arm; and the one-place check over the
records exempts a whole file while any record looks mid-measurement, so six
stale records passed it and were found by a count by hand, rewritten and
measured, ledger 545. #30 and #27 closed with the ear lists; ledger 544.
`completed_plans` 139 counted from the `*-SUMMARY.md` files on disk. 11-07.1
is next.

**11-06.3 merged 2026-09-19 at `1a973b46`.** A shell suite the commit hook
runs can no longer act on the repository that runs it: `scripts/shell-suite.sh`
unsets `GIT_DIR`, `GIT_WORK_TREE`, `GIT_INDEX_FILE`, `GIT_PREFIX` and
`GIT_COMMON_DIR` right after `set -uo pipefail`, before any suite's first
`git`. Two cases in `scripts/which-checks.test.sh` hold it, each starting a
fresh `bash` that sources the harness with one variable handed in and the other
four absent, against a throwaway repository named `elsewhere`; red at
`cdf04ff8` in the shape of each incident, ok at `d5c3483e`. After the green the
suite ran under this repository's absolute git dir and under an absolute copy
of its index, exit 0 over 52 cases, HEAD, the config checksum and the reflog
length unchanged. What the tree contradicted: a case exporting the variable
inside the suite could never go green against an `unset` that runs at source
time, so the cases start the process the way the hook does; the suites cost 43
and 47 s today against the 108 s `CLAUDE.md` gave for 2026-09-10, undiagnosed
and dated beside it. #85 closed; ledger 536 fixed in both halves; no changelog
entry. `completed_plans` 138 counted from the `*-SUMMARY.md` files on disk.
11-07 is next.

**11-06.2 merged 2026-09-19 at `116968fb`.** Tab, F6 or a click into the
message list with no row under the cursor lands on the row somebody was on
when it is still inside the rows, else the first row under the sort, on the
control, so the row is what a screen reader is handed on arrival; a list that
holds a row is left alone when focus comes back; an empty list says "No
messages" once. The rule is `where_to_land_on_arrival`, the fourth question in
`presentation::landing_after_a_removal`; the wiring is
`presentation::list_arrival::wire` on the list's `SET_FOCUS`, the one path the
three ways in share, landing only when the control holds no focused item. A
built tree and list proved the four steps and recorded the focus events: an
arrival raised only the list itself before the fix, which is the "list" the
tester heard, and the list itself then the row after it, the shape a list
already holding a row raises. What the tree contradicted: the remembered index
survives a folder change, since nothing clears it but a saved search and the
viewport rule already trusts it; the rows' count under conversation view is
the view's, not `messages.len()`. #87 closed with the ear list; ledger 543.
`completed_plans` 137 counted from the `*-SUMMARY.md` files on disk. 11-06.3
is next.

**11-06.1 merged 2026-09-19 at `0ed2c1a1`.** After a delete the cursor lands on
the next message, or the previous when the last went, on the control itself,
and a re-read keeps it on the same message by identity; Delete says "Delete"
once and its success is shown and never spoken, the moves the same. The rules
are `presentation::landing_after_a_removal`; `wx_app::land_the_cursor_after`
and `keep_the_cursor_on_its_message` put the cursor on the control through
`put_the_cursor_on`, which raises the focus event even when the control already
held the row. What the tree contradicted: the control keeps the cursor on its
own when a shrink leaves the index in range and holds nothing when the last
row goes with the cursor on it, measured on a built list and kept as the
record of the day. `UIUpdate::Shown` is the third channel, for the eye alone.
11-06.2 lands the cursor on arrival through the same module; 11-07's delete of
a set calls `where_to_land` with its set and lands after it, and its success
lines ride `Shown` through `show_or_say_what_happened_next`. #76 and #83
closed. 11-06.2 is next.

**Three plans inserted on the night of 2026-09-18, against `4d9f14bf`, with the
tree free.** #87 (Tab into the list lands on no row) is 11-06.2 beside 11-06.1,
which is at three tasks: `where_to_land_on_arrival` in 11-06.1's module and a
wiring on the list's focus event that lands only when no item is focused, a
built tree and list proving four steps. #85 (the gate's suites acting on the
real repository from a linked worktree's hook and a partial commit's index) is
11-06.3 right after, shell-only: `shell-suite.sh` clears the five git variables
and two cases are red against a throwaway repository; FOUND-19. #86 (a move
waits for the server; Enter in the Move dialog) is 11-07.1 after 11-07 and
before 11-08: a `moves_waiting` table and module on the flag queue's pattern,
the sync replaying before it lists, the arms completing here first with the
success shown, a refusal undone and said, Enter measured then bound; a move
across accounts stays server-first and is said; #63's proofs re-taken after it.
LIST-20, LIST-21, FOUND-19, criteria 23 to 25, 89 requirements; the waves from
11-07 on moved; `total_plans` 151 from the disk. The current plan stays 9, where
11-05.1's summary put it; 11-06.1 is next.

**11-05.1 merged 2026-09-18 at `b3ab5d51`.** The first Space, the short form,
starts no clock towards marking a message read; the whole reading, Space again
or Shift+Space, and opening with Enter do. #25 was reopened that evening on the
tester's answer to the question 11-05's close comment asked him: reading the
snippet is not reading; at `5c82f680` the mail read-aloud closure wrote
`reading_began` before `SpaceCycle` had decided which form the press reads.
Which press counts is `read_aloud::what_a_press_starts(depth) -> WhatBegan`, a
match on the depth, two cases; `wire_read_aloud` takes a second closure,
`on_whole`, called with the row once the depth is known and only under
`TheWholeReading`, before the text goes out; the mail wiring writes the moment
there, its lookup closure writes nothing, the five PIM calls pass `|_| {}`,
`open_single_message` is unchanged. The target's read-aloud reading is split
into the short-form reading and the whole-reading reading, with one case over
the real cycle and the real decision (a first Space Nothing, a second
TheWholeReading, Shift+Space TheWholeReading, a first Space on another row
Nothing); 11 to 13 tests, `read_aloud.rs` 49 to 51, `wx_app.rs` at 199 before
and after. One red (`3949b288`) and one green (`23fb1157`), documents
`da31cee8`; three records measured, one on the library (77 s) and two on the
target (17 s, 18 s), seven re-measured when the count check asked, all right;
935 records, census 798 + 137; `wx_app.rs` 81 records. The sentence under Mark
as read after says the whole message, Space twice or Shift+Space, or opening,
never the first Space; the guide says the first Space does not count and dates
the build in which it did; a changelog entry above 11-05's; ledger 539 amended
in both halves. Two anchors the plan gave were wrong and the summary says why:
`Some((` is spelled by the write itself, and rustfmt reflows the mail call once
it takes two closures. #25 closed from the merge with the ear list; LIST-03's
amended `[D]` line dated. 8,117 tests. Nothing pushed.

**11-06 merged 2026-09-18 at `fe143d46`.** Mark as Read says which way it will
go. The words for each state are one rule in `application::marking_read`:
`what_the_command_says(any_unread)` answers the Action menu's word, the context
menu's entry, the spoken form and the help, with the mnemonic on the e in both
forms, and `what_the_key_says(now_read)` the one word; five cases, one record.
`context_menu` holds both forms of the message list as static slices whose Mark
entry is the rule's, `entries_for_messages(any_unread)` picks, and
`entries_for(Focus::Messages)` still answers the unread form; 18 tests as
before, three rewritten in place, one record. `presentation::list_keys::wire_letter`
binds a letter on a list and consumes a bare press with `skip(false)`, which is
the whole mechanism under wxdragon's dispatcher; `presentation::toolbar_text::relabel`
sends `TB_SETBUTTONINFOW` with `TBIF_TEXT` and `TB_AUTOSIZE` to the toolbar's
own window, `TBBUTTONINFOW` declared by hand and held at 48 bytes, since
wxdragon 0.9.17 offers no relabel. In `wx_app.rs` the arm's body is
`toggle_read_state(app, a11y, How, frame, toolbar)`, which M on the list also
runs, announcing the sentence under the command and the one word under the
key; `refresh_mark_read_wording` sets the item and its help, the tool's text
and its tip, from the selection handler, the toggle and the `MessageReadToggled`
arm, which reaches the toolbar through a new `UpdateTargets` field; the context
menu is built from the state at the key; the tool is added with the rule's
words and the item keeps its literal so the menu-letter guard can read it, held
to the rule by a reading. `tests/mark_as_read_says_which_way_it_will_go.rs`
reads the letter on a built list (the wired list's selection stayed on row 0
with the handler called once; the companion wired with Q moved to Mango), the
relabel read back through `TB_GETBUTTONTEXTW` and `get_accName` ("Mark as
Unread" both ways, "Mark Read" before), and the source's three refresh sites
with companions; 14 tests. Three reds (`e4726206`, `d144414e`, `e191e373`)
and three greens (`321be675`, `3f1075a3`, `5f4825b8`); six records measured,
two on the library (85 s, 81 s) and four on the target (13 s to 20 s), the two
naming the target re-measured at 14 when the count check asked; 932 records,
census 798 + 134; `wx_app.rs` at 199 before and after, the earcon test
rewritten in place, 80 records. The shortcuts page's two rows say `M` and that
the label says which way it will go on every surface; the guide's context menu
list and two shortcut lists corrected by dating; the changelog entry names #27.
Ledger 540 for the tester's ear; 536 given its second trigger, a partial
commit's temporary `GIT_INDEX_FILE` making the which-checks fixture answer
`all`. The planner's `4b57d312` (11-05.1 inserted) landed on the branch, made
in the same checkout while the plan executed, and one of this plan's green
commits picked up the planner's message from `COMMIT_EDITMSG` during the hook
and was rewritten over the same tree with `commit-tree`. #27 commented from
the merge and left open for 11-07's thread row; LIST-04 held on its first two
`[D]` lines with its box waiting for the third. 8,113 tests. Nothing pushed.
11-05.1 is next; `completed_plans` 134 counted from the `*-SUMMARY.md` files
on disk.

**11-05.1 inserted later on 2026-09-18, against `61865f61`, to run after 11-06,
which is executing on its branch and was not touched.** #25 was reopened on the
tester's word: reading the snippet is not reading. At `5c82f680` the mail
read-aloud closure writes `reading_began` before `SpaceCycle` has decided which
form the press reads, so the first Space started the clock. The plan makes which
press counts one function over the depth (`read_aloud::what_a_press_starts`),
writes the record where the depth is known, gives 11-05's reading the two-press
case, and rewords the sentence under the setting and the guide to reading the
whole message or opening it. LIST-03's `[D]` line and criterion 3 are amended
rather than a new id; the waves from 11-06.1 on moved one; `total_plans` 148
from the disk. The current plan stays 7, where 11-05's summary put it.

**11-05 merged 2026-09-18 at `5c82f680`.** Moving through the message list marks
nothing read. Reading a message aloud from the list with Space or Shift+Space,
or opening it with Enter, records when reading began in
`WxUIState::reading_began`; the selection handler records nothing; the main
timer's `mark_what_was_read` asks `reading_habits::whether_to_mark_read`, which
answers nothing when nothing began whatever is selected, nothing for a message
other than the selected unread one, at once under Immediately, once the wait
has run under a wait and never under Only when I say so, held by six cases; on
an answer the timer does the write it always did. The timer's own `opened_at`
clock, started by selection, is gone. The setting keeps its seven answers and
its default of two seconds, counted from reading now, and a sentence under it on
the Reading tab says so on both channels, read on the built page by
`the_settings_dialog_opens_in`; the guide has "When a message counts as read";
the changelog entry names #25. Five readings and six companions in
`tests/moving_through_the_list_marks_nothing_read.rs`; four records measured
(one on the library, three on targets), 926 records, census 798 + 128;
`wx_app.rs` at 199 before and after; no remedy printed at any commit. What the
tree contradicted: line numbers moved by eleven since the plan; `marks_at_all`
and `delay` would have lost their callers, so the rule reads them. #25 closed
from the merge with the ear list and the ask to confirm that "previewed" means
reading aloud from the list, since the preview pane cannot take focus here by
design. LIST-03 ticked on its `[D]` lines, its `[S]` line ledger 539.
`completed_plans` 133 counted from the `*-SUMMARY.md` files on disk. 11-06 is
next.

**11-04.1 merged 2026-09-18 at `70d84bc5`.** Alt+A reaches the attachments of an
open message and back in both views. In the formatted page window the key arrives
through a second script injected into the page, `presentation::page_jumps`, which
holds the script and the reader of what it posts with a test walking every posted
kind through the reader; the window moves focus to the list and says "Attachments"
with the count, to the warning bar on F7 saying "Security warning", says "No
attachments" or "No warning" with nothing to go to and "Message" on the way back;
the `KEY_DOWN` binding on the WebView, which never fired while the browser had
focus, is gone; `wire_the_way_out` takes which keys a page is given and the
preview takes the way out alone, because its handler pops a context menu for any
message that is not a leave. In the plain-text reader the item is on Alt+A and the
way back is answered from the menu handler when the list has focus, since a frame
takes an accelerator before a list box sees the key, which means F8's way back
there most likely never fired either; reasoned from the toolkit and not watched,
ledger 538. Ten readings in a target of its own, four records measured, 922
records, census 798 + 124, `wx_app.rs` at 199 and `wx_reader.rs` at 14 before and
after. The pages say Alt+A with F8 dated, in the green commit with the key. #84
closed from the merge with the ear list. `completed_plans` 132 counted from the
`*-SUMMARY.md` files on disk. 11-05 is next.

**11-04 merged 2026-09-18 at `03513fd0`.** The log's default follows the version
the build carries and a stored level is kept; the lines a report needs are
written at info and debug and a lexical guard holds every `tracing::` call under
`src/` to spelling none of `body_plain`, `body_html`, `password`, `access_token`
or `refresh_token` as a value, which is what a reading of the text can prove and
no more; the alpha page has the table. The two size rows are owed (ledger 537):
the measurement starts a second copy of the release binary, one copy runs at a
time, and the tester's copy was open on his account through the session, so the
harness now looks first and starts nothing while one runs. Found on the way and
not fixed (ledger 536): `scripts/which-checks.test.sh`'s scratch-repository
fixture inherits the absolute `GIT_DIR` a hook exports from a linked worktree and
acted on the real repository during the planner's commit; the config was restored
by hand and the planner undid its stray commit. `completed_plans` 131 counted from
the `*-SUMMARY.md` files on disk. 11-04.1 is next.

**Five plans inserted and two tasks added on the evening of 2026-09-18, against
`eb5d8517`, while 11-04 executes on its branch untouched.** Six issues filed that
evening: #84 as 11-04.1 (Alt+A for the attachments through the page's script),
#83 as 11-06.1's third task (a delete said once, a shown-only `UIUpdate::Shown`),
#81 as 11-09.1's third task (the earcon player opening its device again on the
stream's error flag, the second mechanism by a measurement), #82 as 11-09.2 (the
snippet as the first relevant words by written rules, Pratik's comment over the
issue's host), #80 as 11-11.1 and 11-11.2 (Open links as a setting, the
activation caught in the page, the message view; the separate window a process of
its own because every WebView in one process shares one WebView2 profile through
wxdragon 0.9.17), #79 as 11-11.3 (a marker counts at the start of any line, after
a probe reproduced it at neither build). LIST-14 to LIST-19, criteria 17 to 22, 86
requirements, the roadmap row `3/20`, every wave from 11-05 on moved; the plans
committed on `main` through the hook as documents. 11-04 is still next and its
files were not touched; the diagnosis and probe logs for #79 are in
`wixen-mail-sweep/probe_79/` beside the seed.

**11-03 is complete and merged at `70f4737b` on 2026-09-18.** On branch
`the-folder-chooser-is-a-tree` from `main` at `309de88a`, seven commits, the whole
gate green on the branch before the merge (8,040 passed and none failed over 75
result lines, 277 s, with the desktop's input idle; two earlier runs at the same
head failed one and two live-window tests while somebody was using the machine,
Firefox in the foreground and keys being pressed, and the same tests passed alone
and in the idle run) and `main`'s hook green at the merge (279 s). Folders to Keep
Up to Date is a `TreeCtrl` with `HideRoot`, `TVS_CHECKBOXES` added through
`SetWindowLongPtrW` before the first item, one item per row in `nesting`'s order
under its parent's item from the stored `parent_id` through `folder_parents`, each
ticked from `syncing` through `TVM_SETITEMW`, every branch open, the cursor on the
first item; Save reads each item through `TVM_GETITEMSTATE` matched to its row by
a native walk (`handles_by_row`, a mismatch writes nothing); no Space handler,
because reading B measured the control toggling by itself under wx; the title the
account's name; the All Mail sentence for Gmail with no listed folder holding every
message; `presentation::native_tree_checks` holds the Windows calls with a
fallback. The reading that decided it found the cause of the tester's "read-only":
`CheckedRows` wrote its states through wxdragon's `acc_state` constants, which are
MSAA's numbers, the shim hands them to `wxAccessible` unconverted, and wxWidgets
numbers its own enumeration differently, so CHECKED arrived as BUSY and SELECTABLE
as READONLY (rows answered 0xc000840 and 0x40); a bare `CheckListBox` row answers
check button with CHECKED on its own, so the object was what broke it. The object
is retired with twenty tests (`names.rs` 32 to 11) and its four records; ledger
534, upstream and not reported. The command is on Tools as `Alt+L` after Pause
Downloading; `blocking.rs`'s sentence says Tools with its two readings holding the
menu; `PROVIDER_SETUP.md`, `KEYBOARD_SHORTCUTS.md`, `ALPHA_TESTING.md` and the
changelog say Tools and the tree, dated. Three reds (`6bad4765`, `0e2bd09a`,
`be5a5b45`) and three greens (`8616d67c`, `613c430f`, `361ff085`) plus a docs
commit (`99293af1`); three records measured (2, 1, 1 red), the module's comment
record re-measured at 18, 19 and 21, four retired; `wx_app.rs` at 199 before and
after. #70 closed at 15:54Z with the ear list; LIST-01 ticked on its `[D]` lines,
its `[S]` lines ledger 533. 914 records, census 798 + 116, ledger 534 with 501
open, 8,040 tests on the gate; the version stays `1.0.0-alpha.1`. Nothing pushed.
What the plan did not have and the tree did: the object in NVDA's path and the
cause, a bare list carrying its tick, a tree item answering check button rather
than outline item, the four `names.rs` records unmeasurable rather than
re-measurable, `scan_fixtures.rs` constructing a `FolderRow`, and the alpha page's
listening item. 11-04 is next.

**11-02 is complete and merged at `1c0e9b0b` on 2026-09-18.** On branch
`the-nvda-runs-verdict-is-its-jobs` from `main` at `37a44643`, four commits, the
whole gate green on the branch before the merge (8,039 passed and none failed over
74 result lines, 362 s) and `main`'s hook green at the merge (340 s). The NVDA
workflow's verdict is its job's since 2026-09-18: `continue-on-error` off the job,
`if: always()` kept on the summary and the upload, the header dated with the run
that reported success over a failed job (35336142908 at `744d05ef`) and the case
that had failed at every run since 2026-09-15 with nobody told;
`accessibility.yml` keeps its own setting on purpose, ledger 532. The settings
tab-row case no longer waits to hear General before its first key, because no
transcript of any case holds a dialog's opening announcement; it takes its mark
after the settle and presses Right, and its comment says what it proves (Compose to
Advanced once each going Right, Feedback once going Left, General not heard going
Right) and no longer proves (General's reading at open, the tester's ear, #33);
read and not run, ledger 531 for its next run. The nvda-tests README lists all five
cases and says what the log holds, ledger 494 closed with it. A sign-in failure in
the Account Manager is one notification: `status_line::shown_and_signalled` puts
the sentence on the line and raises the event with the sentence as its detail, and
the three arms of `reauthorize_selected` that leave the account unauthorised call
it with `AccountNeedsAttention` and nothing else, where before each said the
sentence at High and signalled at Urgent a millisecond apart and the runner's NVDA
spoke only the second; three readings red at `eb2011ad` and green at `a697f61f`,
the account manager's tests at 14 by rewriting in place and the status line's at
3; the sign-in record rewritten onto the new call at 3 red, two new records at 2
and 1, the status-line record re-measured at 4 with the count written at 3, one
run of 7 min 19 s. FOUND-08 ticked on Accessibility run 35336142914's walk of the
five editors (0 without a name on each, ledger 489 closed), FOUND-09 on the
tester's ear (#33 closed 2026-09-18T11:34Z, ledger 492 closed), FOUND-18 on its
`[D]` lines with its `[S]` line the runner's; the roadmap row `2/15` and criterion
12 closed structurally. Two changelog entries under Unreleased, Changed and Fixed;
the version stays `1.0.0-alpha.1`. 915 records by the TOML reader, census 802 +
113, ledger 532 with 499 open, 8,039 tests on the gate, `wx_app.rs` untouched at
199. Nothing pushed. What the plan did not have and the tree did: a second reading
of the Failed arm that would have gone red (rewritten in place), the old sign-in
record's `before` being the call the plan deletes (rewritten and measured), and
ledger 494 being the README rewrite. 11-03 is next.

**11-01 is complete and merged at `316ea755` on 2026-09-18.** On branch
`a-chosen-language-kept-as-chosen` from `main` at `d42b4aed`, three commits, the
whole gate green on the branch before the merge (8,038 passed and none failed over
74 result lines, 295 s) and `main`'s hook green at the merge (273 s). The Settings
screen keeps a chosen spelling language exactly as chosen where this machine cannot
check it: `presentation::which_language_row::which_row_shows` answers a tag with a
region as its own row, available or not, or a row added at the end, and a bare tag
as the checker resolves it with the tag's own row as the fallback 09-02 established;
six cases, four red at `7c8ebda9` against a stub answering Added for everything and
two green on arrival by construction; one record on the library, 2 red and nothing
else; the screen asks it at `wx_settings.rs:890`, the three-line expression that
asked the resolver first is gone, and the record coupling the screen to
`tests/the_language_the_screen_shows_is_the_one_used` is rewritten onto the new
call and measured at 1. That target is unchanged and passes here, because this
machine offers en-AU; the runner's en-AU case is the next push of `main`, Pratik's,
ledger 530. The changelog entry under Fixed names the build
`1.0.0-alpha.1+149.g744d05ef`, the regression's origin in 09-02's fix for #21, and
that CI found it where the tester's machine could not; the version stays
`1.0.0-alpha.1`. FOUND-17 ticked on its two `[D]` lines; the roadmap's criterion 11
closed structurally for its first two clauses and the row at `1/15`. 913 records by
the TOML reader, census 802 + 111, ledger 530 with 500 open, 8,038 tests on the
gate. Nothing pushed. What the plan's behaviour block lacked and the tree had: the
fallback to a bare tag's own listed row, kept, with a sixth case holding it. 11-02 is
next.

**Three plans were inserted later on 2026-09-18, after the plan check.**
Against `main` at `08197657`, for three issues filed that afternoon:
11-06.1 (#76, the cursor after a delete lands on the next message on the
control and a re-read keeps it by id; before 11-07, which lands a set's
delete through its rule), 11-09.1 (#77, attachment said once: the earcon
channel on by default for every event, the attachment event's default the
earcon and the status bar with no speech, the column kept; beside 11-09),
and 11-13 (#75, every status sentence read in one pass to one shape; after
11-11 and before the closing read). Fifteen plans, one per wave, the later
ones up a wave each; `LIST-11` to `LIST-13`; the coverage count 80; the
roadmap's criteria 14 to 16 and its row at `0/15`. The checker's two
blockers (11-02 quoted `wx_managers.rs`'s counts for `wx_account_manager.rs`;
a key is consumed under wxdragon only by `event.skip(false)`, since the
dispatcher resets `Skip(true)` before every closure) and ten warnings are
applied in the same commit. One place the tree could not carry a decision's
words: #77's "and braille" would speak the words, because braille rides the
one screen reader notification here; 11-09.1 says so. The entry as first
written follows.

**Phase 11 is planned and nothing in it is executed.** Twelve plans in
`.planning/phases/11-reading-and-the-list/`, one per wave, written
2026-09-18 against `main` at `744d05ef`, version `1.0.0-alpha.1`, nothing
unpushed. Two plans in front, from what the morning's push showed: CI's
Test Suite job red on `tests/the_language_the_screen_shows_is_the_one_used`
(a stored en-AU rewritten to en-US on a machine that offers only en-US,
a regression of 09-02 that passes here because this machine offers en-AU;
11-01), and the NVDA workflow reporting success over a job that failed on
two cases, one of which has failed at every run since 2026-09-15 with
nobody told, because the job is `continue-on-error` (11-02, which also
makes a sign-in failure one notification, corrects the settings case's
first wait, ticks FOUND-08 on the Accessibility run's walk and FOUND-09 on
the tester's ear, #33 closed the same day on his word). Then the fourth of
Pratik's seven groups in his order: the folder chooser as a tree with a
native check state, the account's name, All Mail said, the command on
Tools (11-03, #70); the log level's default from the version and the lines
a report needs (11-04, #71); nothing marked read by moving (11-05, #25);
Mark as Read's label on three surfaces and M (11-06, #27); the selection
and every command over it, with #27's thread (11-07, #30); a thread row's
message chosen in SQL, the preview and the window following, the
conversation's text as one chunk (11-08, #31); the row's columns on
request and the NVDA profile steps (11-09, #26); a rule's phrase said
first, a sound once per check, the labels as a column (11-10, #62);
pictures shown by default except pixels, the link's words, the undescribed
rule and its setting, the privacy page's tracking section (11-11, #28, #29);
the pages and the closing read (11-12). Requirements `LIST-01` to `LIST-10`
under "Reading, and the list" and `FOUND-17` and `FOUND-18` beside
FOUND-16; the coverage count 77. Every file and line the issues cite was
re-run; the premises that moved are in the README's table, the largest
that the chooser has been on Action, This Folder since 2026-08-26 and that
the preview under conversation view shows a message unrelated to the row.
Fourteen decisions in the README, each overrulable with a reason. The
tester's profile was read once through Python for four facts, quoted with
the date. `gsd-tools query estimate-calibration` still answers factor 1
with no samples; the factor used is 0.43 from phase 10's ten summaries.
#72 (the status bar and F6) is held by Pratik's decision of 2026-09-18 and
belongs to no group. The earlier entry, still true, follows.

**Phase 10 is complete: 10-07 merged at `d5529ee8` on 2026-09-18.**

**10-07 is complete and merged at `d5529ee8` on 2026-09-18, and phase 10 with it.** On
branch `the-pages-say-what-the-program-does-now` from `main` at `de0d45e2`, two
documents tasks, each commit `docs_only` through the hook, the whole gate green on the
branch before the merge (8,032 passed and none failed, 439 s) and `main`'s hook green
at the merge. `docs/ALPHA_TESTING.md` says in its short version that mail comes down
whole and keeps coming since the build of 2026-09-18 and that none of it has met a real
account, with the download, the watch and the schedule, and the three announcement
levels, in its known-missing list; `docs/privacy.md`'s mail-provider row names the
download, one section says the text of every message is on the disk under the default
and what a size does, and one says what a whole-mailbox download tells a provider and
does not (#29's line), that a connection is held open all day, and that reads resume on
the network without Go Back Online; `docs/USER_GUIDE.md` gains Getting your mail and
the Check Interval field; `docs/manual-accessibility-pass.md` gains items 44 to 57, one
per sentence the phase's summaries list as unheard. The closing read: MAIL-01 to
MAIL-05 ticked clause by clause with every `[D]` line named from the tree and every
`[S]` line left with its ledger numbers; the roadmap's criteria 1 to 6 closed with the
dated sentence and 7 to 10 by their own plans; the progress row `10/10`, Complete.
The ledger corrections the plan asked for were already made by 10-05 and 10-06 and the
new entries it named are held by 515, 521 and 525, so none was written twice; the one
new entry is 529, the privacy page's OneNote section stale since phase 5.2. #29
commented from the merge commit; no other issue needed one, every close comment agreeing
with the tree. 912 records by the TOML reader, census 802 + 110, 8,032 tests on the
last gate, ledger 529 with 499 open. Nothing pushed, 169 commits ahead. What is next:
an installer from `main` at or after `d5529ee8` for the tester, and group 4 of Pratik's
order, #70 first, planned from the README's table.

**10-06 is complete and merged at `2da50b6b` on 2026-09-18.** On branch
`the-watch-that-keeps-going` from `main` at `9cea7c87`, two `tdd` tasks and
a documents task, red then green each with a second red in task 2 that the
release binary demanded, the whole gate green on the branch on its first
run (8,032 passed and none failed, 435 s) and again on `main`'s hook at the
merge (430 s). `application::checking_on_a_schedule` decides which accounts
are due over the account editor's Check Interval, clamped 1 to 60, whether
a watch that ended is tried again (`AfterAWait` for a dropped connection,
`Never` for a stop somebody asked for, `OnTheScheduleAlone` with what lifts
it after three refusals), and what the status line says. `wx_app` holds an
`InboxWatch` per enabled IMAP account with its own `WaitBeforeTryingAgain`;
the `Stopped` arm and the start-failure branch both ask
`what_the_watch_does_next`; the timer's ten-second block starts the watches
whose wait is over beside the download's wait, and its minute look checks
the due accounts while there is a network; the network coming back cuts
every wait short, asks for every watch and checks the due accounts; a start
asks for every watch and checks every enabled account after the fill; F9
checks every enabled account through one worker that walks the list, marks
each synced, ends each with its own `MailboxWatchRequested(id)`, and asks
for the download once and only when some account went through.
`say_the_watch_is_off` and its sentence are gone; the account editor's
interval field carries `WHAT_THE_INTERVAL_DOES` on the field and beneath
it. A new target, `mail_keeps_arriving_on_its_own`, seven readings and
seven companions, coupled to `wx_app.rs` by seven measured records; ten
records new, one corrected for an indent and measured again, two measured
again, 912 records, census 802 + 110. The release binary started twelve
times through the harness against temporary profiles: the measurement
account is refused by the credential store and not the port, because the
profile stores no password, and the cold-start and idle rows were re-taken
under that condition, 536 ms and 373 MB, the old rows dated. The changelog
entry under Unreleased, Fixed; the F9 row on the shortcuts page; ledger 446
closed, 447, 64 and 65 corrected by addition, what only the tester's
account and ear settle in 525, the socket refusal still unread in 526, the
departures in 527, `last_sync` written and read by nothing in 528. #37
closed from the merge commit with the ear list. `completed_plans` 126
counted from the `*-SUMMARY.md` files on disk. 10-07 is next, the closing
read, and reads the watch from the tree: the three status sentences are
`what_the_status_line_says`, the interval is per account on the account
editor and not on the Settings screen, reads follow the network and sends
follow offline mode.

**10-05 is complete and merged at `b477e8c9` on 2026-09-18.** On branch
`everything-comes-down-without-being-asked` from `main` at `89a4e105`, two
`tdd` tasks and a documents task, red then green each, the whole gate green
on the branch on its first run (7,998 passed and none failed, 425 s) and
again on `main`'s hook at the merge (427 s). Every check for mail ends by
sending `UIUpdate::DownloadRequested`, whose arm calls
`wx_app::start_the_download`: for every enabled IMAP account in list order
it asks `bringing_everything_down::what_to_do_next` and does the one thing
answered, a chunk of headers through `sync_folder` at `INITIAL_FETCH_LIMIT`
or a chunk of text through `fetch_over_a_mailbox`, the folder on screen
read from the state at each ask, resumable because its state is the cache.
One flag, `downloading.paused`, is asked before each chunk of headers and
handed to each chunk of text. A refused chunk ends the run; the wait rule
is asked, `next_attempt_at` is recorded on `WxUIState::downloading`, and
the main timer starts the next attempt on the network's cadence, retrying
at the cap for as long as the program runs and is not paused, with the
reason in the doc comment. Every line on the way is `Progress`; one
`WhatArrived` per account that had anything to do. Get Older Messages
answers the key and hands to the download; Pause Downloading is a check
item on Tools, Alt+P, described by
`allowed::DOWNLOADING_EVERYTHING_IS_EXPERIMENTAL`, the one sentence that
replaced the two warnings. Download This Whole Folder, Fetch Missing
Message Text, the offer button above the list and
`application::asking_for_a_whole_folder` are gone; the `WhatCouldBeFetched`
arm says what the count of missing text means. The both-bounds target is
`everything_comes_down_without_being_asked` now, nine readings and nine
companions; five records new, three rewritten in place, one renamed, one
corrected by hand, every one measured, 902 records, census 802 + 100. The
changelog entry under Unreleased, Changed, and four older entries dated;
the Pause row on the shortcuts page; ledger 12 closed, 11 and 72 corrected
by addition and 72 re-pointed at `bringing_everything_down.rs`, the
departures in 522, what only the tester's account and ear settle in 523,
the text pass's entry point and fold reached by their tests alone in 524.
#20 and #23 closed from the merge commit. `completed_plans` 125 counted
from the `*-SUMMARY.md` files on disk. 10-06 is next, and reads the runner
from the tree: the download is started from the `DownloadRequested` arm
alone, refuses to start while a wait is running, and the watch wants a
`WaitBeforeTryingAgain` of its own.

**10-04 is complete and merged at `19a10706` on 2026-09-18.** On branch
`what-is-said-while-fetching` from `main` at `fb0e8bce`, two `tdd` tasks
and a documents task, red then green each, the whole gate green on the
branch on its first run (7,995 passed and none failed, 442 s) and again on
`main`'s hook at the merge (431 s). How much is said while mail and the
other modules are fetched is a setting: `application::what_is_said_while_fetching::HowMuchToSay`,
offered at the end of the Feedback tab under While fetching as Say what
arrived, Say every step and Errors only, Say what arrived by default, which
is the tester's shape in #38, and what a settings file from before this
existed answers. The window holds it on `Accessibility` beside the feedback
settings, set at startup and on OK. Every line a fetch says on the way goes
out as `UIUpdate::Progress`, shown always and spoken at Low only under Say
every step; what a check brought goes out once after the loop as
`UIUpdate::WhatArrived`, folder by folder with counts through `how_many`,
only when something arrived, and its arm is where the new-mail sound is
signalled now rather than where the watch wakes; the four module syncs
carry their counts as the Sync finished event's detail under the level, the
tasks and notes syncs through a new `ModuleSyncFinished`; `StatusUpdated`
is the answer channel at Normal, so Settings saved is heard above a check;
`WholeFolderProgress` folded into `Progress`. A new target reads the
window's shipping half for the arms, the mail check's five lines, the
signal's one place and every answer-channel call's opening, with a
companion per claim; five records measured, three rewritten onto moved
lines and re-measured, twenty re-measured, two corrected by hand first, 897
records, census 802 + 95. The changelog entry under Unreleased, Changed;
listening items 42 and 43; the departures in ledger 520, what only the
tester's ear settles in 521. #38 closed from the merge commit.
`completed_plans` 124 counted from the `*-SUMMARY.md` files on disk. 10-05
is next, and reads the kinds from the tree: a step is `Progress`, the counts
are one `WhatArrived` per check, and the two commands it retires already
send steps.

**10-03 is complete and merged at `c4203632` on 2026-09-17.** On branch
`how-much-message-text-stays` from `main` at `e33dab5a`, two `tdd` tasks,
red then green each, the whole gate green on the branch on its first run
(7,960 passed and none failed, 438 s) and again on `main`'s hook at the
merge (432 s). How much message text stays on this computer is a setting:
`application::keeping_message_text::TextKept`, `All` or `UpTo(bytes)`,
offered under Message Text on the Permissions tab beside the box that
forbids fetching as All of it, Up to 1 GB, Up to 5 GB and Up to 20 GB, All
of it by default, which is the tester's decision in #23, and what a settings
file from before this existed answers; a garbled value reads as All, because
a bound read by mistake evicts and All loses nothing. The eviction at the end
of every folder sync reads it through `keeping_bodies_under(TextBudget)`,
typed now, and evicts nothing under All where it dropped text above 512 MiB
before; the two workers that evict, the check and the whole-folder request,
read it once through `how_much_message_text_stays()` and hand it to their
cache, and the window's cache, which never evicts, is not handed it. A new
target builds the real dialog, chooses each size and reads it back the way
OK does, holds a page nobody showed to leaving the stored size alone, and
reads the two workers' bodies for the seam; four records measured, eleven
re-measured after `bodies.rs` gained a test, 892 records, census 802 + 90.
The changelog entry under Unreleased, Added, with the known limitation that
the download itself is 10-05; the version stays `1.0.0-alpha.1`. Four
departures in ledger 518, what only the tester's ear settles in 519. #23
commented from the merge commit and left open for 10-05. `completed_plans`
123 counted from the `*-SUMMARY.md` files on disk. 10-04 is next.

**10-02.2 is complete and merged at `44bff634` on 2026-09-17.** On branch
`a-build-carries-an-ordered-counter` from `main` at `36882a21`, one `tdd`
task, red then green, and one document task, the whole gate green on the
branch on its first run (7,945 passed and none failed, 413 s) and again on
`main`'s hook at the merge (419 s). Pratik's decision of that day: a build
handed to a tester keeps `1.0.0-alpha.1` as the round's name and carries,
after the plus, how many commits it is past the commit that set its version
and then the commit, `1.0.0-alpha.1+114.g44bff634` from `main` after the
merge, with the same counter in the Windows file version as
`stage * 13000 + step * 1000 + counter`, the step held to 12 and the counter
to 999 with a loud line each; a clone without the version's commit is
refused with a sentence; CI's Build job checks out the history.
`tests/installer.rs` reads the rule off the script and orders eleven builds
in the order they are made; `tests/house_style.rs` holds the refusal, the
order of the two computations and the Build job's checkout. Five records
measured or re-measured, one of them re-anchored because the plan's
addition duplicated its `before` line; 888 records, census 802 + 86. The
rule in `CLAUDE.md` and the changelog with the date and the old shape
dated. One installer built from `main` at `44bff634` to read the string
and the file version back (`1.0.0.14114`), left in `dist/`, handed to
nobody; ledger 517; FOUND-16 ticked, its `[S]` line untouched.
`completed_plans` 122 counted from the `*-SUMMARY.md` files on disk. 10-03
is next.
...
|----------|------|--------|-------------|-----------|
| Protocol | Gmail X-GM-THRID and X-GM-RAW | v2; corrected 2026-09-20: X-GM-THRID landed in 11-08.1 on 2026-09-19, only X-GM-RAW stays v2 | 2026-08-29 | this one |
...
Last session: 2026-09-24T23:59:00Z
Stopped at: Phase 13 planned, fifty-three plans against `main` at `630e2a67`, nothing executed; `13-01-PLAN.md` (Undo and Redo on the Edit menu) is next, then the rest in wave order, 13-51 last at wave 53. Four answers wait on Pratik before the plans that need them: (b) before 13-03 and 13-20, (c) before 13-28, (a) before 13-47; (d) is a ledger entry. The roadmap's phase 13 entry, plan list and row at `0/53`; `REQUIREMENTS.md`'s GAP lines naming their plans; this file by hand. The commit landing the plans is on `main` and not pushed.

Earlier: Phase 12 complete. 12-12, its closing plan, on branch `12-12-phase-close`: the pages, the listening lines (items 84 to 95) and the closing read, then the full gate at `566116d3`, exit 0 after 516 s with 8,985 tests passed. Phase 13 is planned next, once Pratik confirms the order inside it. Until 2026-09-24 this line read, from 2026-09-20: "Phase 12 planned, twelve plans against `main` at `0ad66e48`, nothing executed; 11-11.2 and 11-13 moved in as 12-02 and 12-03; phases 13 and 14 written as roadmap entries and requirements only; `12-01-PLAN.md` (the NVDA run's red case) is next, then the rest in wave order, 12-12 last. `REQUIREMENTS.md` at 119; the roadmap's phase 12 entry, criteria, plan list and row at `0/12`, phase 11's row at `29/29` with its line ticked; this file by hand. Nothing pushed."

Earlier: 11-12 complete and merged at `9ee0e9a8`; the phase closed with 29 of 31 plans merged, 11-11.2 and 11-13 deferred to the front of the next phase on Pratik's decision of 2026-09-20; the pages say what the list and the reader do now and that none of it has been heard, items 58 to 83 on the listening page, twenty-four LIST ticks standing and three open with the reason, ledger 566; nothing pushed, Pratik's push next.

Earlier: 11-09.2 complete and merged at `4d9a41d2`; a message row's snippet is the message's first relevant words by written rules in `application::snippet`, one derivation for the save and the pass, every stored snippet recomputed once on the next start; #82 closed, LIST-17 ticked, ledger 554 and 555; `11-10-PLAN.md` (a rule's phrase said first and shown in a column) is next.

Earlier: 11-09 complete and merged at `bd5f6929`; `Ctrl+Shift+;` and an Action item read the row under the cursor column by column with its headings, once, as content the mute controls, composed from the cells the list paints; the header on every row is NVDA's own setting and the shortcuts page gives the profile steps; #26 closed, LIST-07 ticked, ledger 550 and 551; `11-09.1-PLAN.md` (the attachment said once, the earcons after hours) is next.

Earlier: 11-06.3 complete and merged at `1a973b46`; the gate's suite harness clears the five git variables a commit hook hands its children, two cases red against a throwaway repository hold it, #85 closed, ledger 536 fixed, FOUND-19 ticked.

Earlier: 11-01 complete and merged at `316ea755`; a chosen spelling language kept as chosen where this machine cannot check it, the rule in `presentation::which_language_row` with six cases and a measured record, the screen asking it, the coupling record rewritten and measured, the changelog naming 09-02 and #21, FOUND-17 ticked on its `[D]` lines, ledger 530 for the runner's case; `11-02-PLAN.md` (the NVDA workflow's verdict is the run's) is next.

Earlier: Phase 11 planned, fifteen plans after three inserts (11-06.1, 11-09.1, 11-13 for #76, #77, #75) and the plan check's edits, nothing executed; `11-01-PLAN.md` (a chosen spelling language kept as chosen, CI green at the next push) is next, then the rest in wave order, 11-13 before 11-12. `REQUIREMENTS.md` holds LIST-01 to LIST-13 and FOUND-17 and FOUND-18 at 80; the roadmap's phase 11 entry and row are written; the README carries Pratik's groups with 5 to 7 still later phases and #72 held.

Earlier: 10-07 complete and merged at `d5529ee8`, and phase 10 complete with it: the four pages say what the program does now, the listening page holds items 44 to 57, MAIL-01 to MAIL-05 are ticked clause by clause, the roadmap's row reads `10/10`, ledger 529; #29 commented from the merge commit. Next: an installer from `main` for the tester, and group 4 of Pratik's order, #70 first. Earlier: 10-01.1 complete and merged at `d020aa60`; the six later Settings panels painted at the end of their own build so every check box stays a check box over MSAA, and a page reached from inside a page handing focus to its first control; two targets coupled to `wx_settings.rs` by measured records; #67 and #68 closed with the ear list; ledger 513 and 514; FOUND-13 and FOUND-14 ticked; 10-02 is next. Before that: 10-01 complete and merged at `d8e887d6`; the wait rule, the model of everything and the chunk-bounded text pass are in the tree with their eleven records, called by nothing a person can reach until 10-05 and 10-06; ledger 512; #20 and #23 commented; nothing pushed, 100 commits unpushed before the commit that lands the summary. 10-02 is next.
