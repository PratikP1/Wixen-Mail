...
Phase: 05 (The other five modules keep up). **2 of 8 plans done.** 05-01 a moved day of a series shown once, and a day changed on its own saying so in the row a screen reader reads while arrowing; 05-02 a week view and a month view, Prev and Next moving by one period and saying which, and the chosen view surviving a restart. `main` is at `a8de443`, version `0.94.0` on the branch, and nothing is pushed.
