...
Last session: 2026-09-19T14:45:00Z
Stopped at: 11-09 complete and merged at `bd5f6929`; `Ctrl+Shift+;` and an Action item read the row under the cursor column by column with its headings, once, as content the mute controls, composed from the cells the list paints; the header on every row is NVDA's own setting and the shortcuts page gives the profile steps; #26 closed, LIST-07 ticked, ledger 550 and 551; `11-09.1-PLAN.md` (the attachment said once, the earcons after hours) is next.
