...
Phase: 06 (How the application speaks). **06-06 is complete: task 2 on
branch `a-pinned-scanner-and-every-window-it-can-reach`, red `741d2b36` and
green `fd661401`, still version 0.123.0. Both checkpoint answers are
