...
state_head: 3fc3ab2ba4c1a5d2d443e5e70e5ba406670b7ff2
progress:
  total_phases: 13
  completed_phases: 0
  total_plans: 87
...
Phase: 04.1 (Mail moves between accounts). IN PROGRESS, 1 of 4 plans done and merged. 04.1-01 a destination is a folder in an account, one builder feeding the sidebar and the move window, and the All Inboxes defect closed. Version `0.88.0`.
