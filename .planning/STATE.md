...
Phase: 06 (How the application speaks). **06-05 is complete: both tasks on
branch `said-at-once-and-the-window-a-look-later` at `106efe6c`, merged
into `main`, version 0.123.0. A reminder due while somebody is typing is
