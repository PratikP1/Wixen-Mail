...
Phase: 06 (How the application speaks). **06-09 task 1 of 4 is complete and
the plan is stopped at its checkpoint**, on branch
`a-due-thing-says-what-it-is-first`, red `c189a361`, green `0ca6099d`,
records `a993d9d5`, the summary in the commit after, merged into `main`
with the merge commit named in the docs commit that follows it, still
