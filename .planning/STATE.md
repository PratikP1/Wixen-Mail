...
**Current focus:** Phase 08 (Every number the project quotes), 08-01 to 08-08 merged and complete, the guard sweep and the two mutation runs done on GitHub's runners and every finding corrected, killed or given its reason; 08-09 closes the phase

## Current Position

Phase: 08 (Every number the project quotes). Current Plan: 8 of 9.
**08-08 is complete, 8 of 9.** Pratik dispatched the two mutation runs on
