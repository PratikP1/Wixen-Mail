...
**Requirements**: LIST-01, LIST-02, LIST-03, LIST-04, LIST-05, LIST-06, LIST-07, LIST-08, LIST-09, LIST-10, LIST-11, LIST-12, LIST-13, LIST-14, LIST-15, LIST-16, LIST-17, LIST-18, LIST-19, LIST-20, LIST-21, FOUND-17, FOUND-18, FOUND-19
**Success Criteria** (what must be TRUE):
...
**Plans**: twenty-four, one per wave, listed in `phases/11-reading-and-the-list/README.md`,
...
Enter in the Move dialog) after 11-07 and before 11-08. One per wave because eighteen of the
twenty-four write `src/presentation/wx_app.rs`, every one writes `docs/changelog.md` and all
...
changes, #31, #26, #77 with #81 beside it, #82 beside that, #62, #28 with #29, then #80 in
...
- [ ] 11-12-PLAN.md: The pages, the listening lines, and the phase's closing read (all twenty-one and #25's correction)
