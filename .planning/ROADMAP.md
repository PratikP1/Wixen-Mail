...
- [ ] 12-06.1-PLAN.md: The typing field's name in the running program: each naming call logged at warn and the program's log uploaded by the scan on Pratik's exception of 2026-09-24, the cause read from one scan run, a test reproducing it red then green, the scan on the pull request reading the names on both channels (ledger 408 to 425, 593; #73, #35; EDIT-01)
