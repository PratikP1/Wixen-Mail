...
a red NVDA run.
**Requirements**: FOUND-20, LIST-19, LIST-11, ALPHA-01, ALPHA-02, ALPHA-03, EDIT-01, EDIT-02, EDIT-03, EDIT-04, EDIT-05; and FOUND-21 (12-02.1, inserted 2026-09-22, which this line did not name until 2026-09-23) and FOUND-22 (12-03.1, inserted 2026-09-23) and FOUND-23 (12-03.2, inserted later on 2026-09-23)
**Success Criteria** (what must be TRUE):
  ...
  7. The contact editor has a prefix with the common titles and room to type another, a
     ...
     and a number kept as typed with a country beside it, neither refusing a real one; the
  ...
  9. Signatures are one set: the manager lists every signature and says which accounts use
     it; an account's own dialog chooses its signature; one default serves every account
...
executors, with the full gate moved from every merge to 12-12. Twelve at first, listed in
...
- [ ] 12-09-PLAN.md: Signatures as one set with assignments per account and one default, the manager's Used by column, the choice on the account's dialog, compose following the From account (#43; EDIT-04)
