...
12,872 reads as one list with a screen reader, and what each announcement level sounds like.

**Plans**: seven, one per wave, listed in `phases/10-all-the-mail-and-what-is-said-while-it-comes/README.md`,
planned 2026-09-17 against `main` at `7d57cd49`. One per wave because five of the seven write
...
The order is the dependency order: the model, then the list, then the text budget, then what
is said, then the runner, then the watch, then the documents. Each plan ends with the `gh
...
- [ ] 10-01-PLAN.md: The model of everything for one account, one wait rule for a server that refused, and the text pass bounded per chunk with the provider's answer read (#20, #23, #37)
...
| 10. All the mail, and what is said while it comes | 0/7 | Planned 2026-09-17 against `main` at `7d57cd49`, nothing executed | - |
