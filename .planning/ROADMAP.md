...
- [ ] 13-04-PLAN.md: Print from the reader window, a conversation row, the formatted conversation window and the other five modules; GAP-01 ticked, #45 closed (#45, GAP-01)
...
| 13. New features, most from the Outlook gap audit | 3/53 | In progress: 13-01 done on 2026-09-24, Undo and Redo on the main window's Edit menu, Undo Send third on N; 13-02 done on 2026-09-25, the print layout in `application::printing` with the five items' fields shared by speech and paper; 13-03 done on 2026-09-25, File, Print and Ctrl+P on the message list through Windows' print dialog, drawn with GDI and spooled as one job; 13-04 next; Pratik answered (a) to (d) on 2026-09-24, and (d), the wxDragon issue, waits on his test program before anything is filed. Planned 2026-09-24 against `main` at `630e2a67` after he confirmed the order that day: fifty-three plans, one per wave, 13-17.1 and 13-24.1 added by the planners | - |
