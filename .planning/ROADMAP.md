...
**Requirements**: LIST-01, LIST-02, LIST-03, LIST-04, LIST-05, LIST-06, LIST-07, LIST-08, LIST-09, LIST-10, LIST-11, LIST-12, LIST-13, LIST-14, LIST-15, LIST-16, LIST-17, LIST-18, LIST-19, LIST-20, LIST-21, LIST-22, FOUND-17, FOUND-18, FOUND-19
**Success Criteria** (what must be TRUE):
...
**Plans**: twenty-five, one per wave, listed in `phases/11-reading-and-the-list/README.md`,
...
decision that kept a move across accounts server-first, between 11-07.1 and 11-08. One per
wave because nineteen of the twenty-five write `src/presentation/wx_app.rs`, every one writes
...
changes, its second half right after, #31, #26, #77 with #81 beside it, #82 beside that, #62, #28 with #29, then #80 in
...
- [ ] 11-12-PLAN.md: The pages, the listening lines, and the phase's closing read (all twenty-two and #25's correction)
