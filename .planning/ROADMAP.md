...
- [ ] 12-10-PLAN.md: Labels with a stored order, the submenu rebuilt from the account's labels with their keys and Edit Labels, the manager's moves and Key column, one word (#48; EDIT-05)
