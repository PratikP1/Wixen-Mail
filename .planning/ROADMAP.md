...
- [ ] 13-02-PLAN.md: What a printed page holds and where it breaks: a pure layout module, and one field list speech and paper share (#45, GAP-01)
...
| 13. New features, most from the Outlook gap audit | 1/53 | In progress: 13-01 done on 2026-09-24, Undo and Redo on the main window's Edit menu, Undo Send third on N; 13-02 next; four answers wait on Pratik, (a) to (d) in the phase README. Planned 2026-09-24 against `main` at `630e2a67` after he confirmed the order that day: fifty-three plans, one per wave, 13-17.1 and 13-24.1 added by the planners | - |
