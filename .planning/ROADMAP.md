...
**Success Criteria** (what must be TRUE):
  ...
  1. The NVDA case for #80 is green for the reason its second half was written: after
     ...
     program says, held by a reading in the Rust gate (FOUND-22).
  2. The third place a link can open, a separate Wixen Mail window, is a process of its own
     ...
     (#80, second half; LIST-19; phase 11's criterion 22)
  ...
  7. The contact editor has a prefix with the common titles and room to type another, a
     ...
     Favourite box's name is re-read over MSAA. (#40 points 1 to 4; EDIT-02)
  8. A new event, task or reminder starts at the next block boundary after now and ends one
     ...
     pure and held at every boundary. (#41; EDIT-03)
  9. Signatures are one set: the manager lists every signature and says which accounts use
     ...
     had; the schema is additive and the version does not move. (#43; EDIT-04)
...
- [ ] 12-12-PLAN.md: The pages, the listening lines, and the phase's closing read (all eleven requirements)
