...
- [ ] 13-03-PLAN.md: File, Print and Ctrl+P on the message list through Windows' print dialog, drawn with GDI and spooled as one job; a spool target with `WIXEN_NO_PDF_PRINTER` on CI; the checkpoint for the three `windows` features, answer (b), and the wxDragon issue drafted, answer (d) (#45, GAP-01)
...
| 13. New features, most from the Outlook gap audit | 2/53 | In progress: 13-01 done on 2026-09-24, Undo and Redo on the main window's Edit menu, Undo Send third on N; 13-02 done on 2026-09-25, the print layout in `application::printing` with the five items' fields shared by speech and paper, reached by nothing until 13-03; 13-03 next; four answers wait on Pratik, (a) to (d) in the phase README. Planned 2026-09-24 against `main` at `630e2a67` after he confirmed the order that day: fifty-three plans, one per wave, 13-17.1 and 13-24.1 added by the planners | - |
