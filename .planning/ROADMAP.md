...
- [ ] 13-01-PLAN.md: Edit, Undo and Redo on the main window's Edit menu on the box's own one step, greyed while the menu is open and speaking when pressed; Undo Send third, its letter U to N (#47, GAP-02)
...
| 13. New features, most from the Outlook gap audit | 0/53 | Planned 2026-09-24 against `main` at `630e2a67` after Pratik confirmed the order that day: fifty-three plans, one per wave, 13-17.1 and 13-24.1 added by the planners; nothing executed, 13-01 next; four answers wait on him, (a) to (d) in the phase README | - |
