...
- [ ] 10-02.1-PLAN.md: All Inboxes, a label view and a saved search read in the sort that was chosen, the way a folder is, with what a chosen sort costs measured (#69)
- [ ] 10-02.2-PLAN.md: A build carries how many commits it is past its version, in the string and in the Windows file version, and the rule says so (Pratik's decision of 2026-09-17)
