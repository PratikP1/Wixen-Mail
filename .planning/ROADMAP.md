...
now would rot against a tree phase 12 changes.
...
**Success Criteria** (what must be TRUE):
  ...
  12. The alpha page and the user guide say what the editors, the About and Send Feedback
      ...
      its merge, and the phase line stays open until it is green.
