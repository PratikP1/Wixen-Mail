...
- [ ] 12-09-PLAN.md: Signatures as one set with assignments per account and one default, the manager's Used by column, the choice on the account's dialog and in the manager, one stored assignment (added 2026-09-23), compose following the From account (#43; EDIT-04)
