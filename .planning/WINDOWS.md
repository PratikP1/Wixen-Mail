...
fixed_count: 54
total_count: 592
last_updated: 2026-09-23T22:30:00.000Z
---
...
| 412 | 06 | todo | src/presentation/wx_item_form.rs |  | Scan finding, Edit Event row 19: the text field of the Ends Day spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Ends Day over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:28:41.723Z | 2026-09-23T21:30:21.000Z |
| 413 | 06 | todo | src/presentation/wx_item_form.rs |  | Scan finding, Edit Event row 20: the text field of the Ends Year spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Ends Year over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:28:42.170Z | 2026-09-23T21:30:21.000Z |
| 414 | 06 | todo | src/presentation/wx_item_form.rs |  | Scan finding, Edit Event row 21: the text field of the End time Minute spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers End time Minute over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:28:42.628Z | 2026-09-23T21:30:21.000Z |
...
| 419 | 06 | todo | src/presentation/wx_send_later.rs |  | Scan finding, send-later row 25: the text field of the Send on Day spinner has no name on either channel. The name Send on Day is on the arrows; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send on Day over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:13.982Z | 2026-09-23T21:30:21.000Z |
| 420 | 06 | todo | src/presentation/wx_send_later.rs |  | Scan finding, send-later row 26: the text field of the Send on Year spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send on Year over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:14.419Z | 2026-09-23T21:30:21.000Z |
| 421 | 06 | todo | src/presentation/wx_send_later.rs |  | Scan finding, send-later row 27: the text field of the Send at Hour spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send at Hour over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:14.853Z | 2026-09-23T21:30:21.000Z |
| 422 | 06 | todo | src/presentation/wx_send_later.rs |  | Scan finding, send-later row 28: the text field of the Send at Minute spinner has no name on either channel; as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send at Minute over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:15.269Z | 2026-09-23T21:30:21.000Z |
...
| 424 | 06 | todo | src/presentation/wx_item_form.rs |  | Found in the scan's tree, no rule fired: the text field of the Start time Hour spinner is named Start time on UI Automation, the text of the static label before it, which the platform gives to an unnamed edit; the arrows beside it say Start time Hour. On MSAA it has no name and the walk reported it. A name that is present and wrong is one no scanner rule sees; only a person hears it. Fix as 408 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Start time Hour over MSAA and over UI Automation, the same words as its arrows, where it answered nothing on MSAA and Start time, the label before it, on UI Automation; read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:16.128Z | 2026-09-23T21:30:21.000Z |
| 425 | 06 | todo | src/presentation/wx_item_form.rs |  | Found in the scan's tree, no rule fired: the text field of the End time Hour spinner is named End time on UI Automation and nothing on MSAA; as 424 | fixed | Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers End time Hour over MSAA and over UI Automation, the same words as its arrows, where it answered nothing on MSAA and End time, the label before it, on UI Automation; read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push | 2026-09-14T15:29:16.558Z | 2026-09-23T21:30:21.000Z |
...
| 566 | 11 | todo | src/application/opening_links.rs | 174 | 11-12: the program promises the separate window with the next build, and since 2026-09-20 that is not so. WHAT_EACH_CHOICE_COSTS, the sentence under Open links on the Reading tab, ends by saying that a separate Wixen Mail window arrives with the next build and opens the browser until then, and SEPARATE_WINDOWS_ARRIVE_LATER, the status line when that choice is taken, says that separate windows arrive with the next build and the page was opened in the browser; test_the_words_on_the_reading_tab_name_the_trade_and_the_wait holds the first to the words next build. 11-11.2, the plan that builds the window and retires both sentences, was deferred to the front of the next phase on Pratik's decision of 2026-09-20, so the next build carries the promise and not the window. The closing read, 11-12, is documents only and reworded the guide, the shortcuts page and the changelog to a later build, and the guide says the program's own sentences still say the next build. The remedy is 11-11.2 landing, or, if the next build goes out first, the two sentences reworded to a later build with the test rewritten in place, a code change on a branch with its red | fixed | Fixed by 12-02 on 2026-09-22, the plan 11-11.2 became. The window exists: a1774d9e built the page process, its window and its browser profile of its own, and the green after c192ad03 pointed the third route at it. WHAT_EACH_CHOICE_COSTS now ends by saying a separate Wixen Mail window is a process of its own with a browser profile of its own that shares nothing with the message preview and closes when the window does; SEPARATE_WINDOWS_ARRIVE_LATER is gone with the arm that spoke it, and test_the_words_on_the_reading_tab_name_the_trade, the test that held the first sentence to the words next build, holds it to profile, Backspace and process and to saying nothing about a build. test_nothing_in_the_program_still_says_a_separate_window_is_coming in tests/a_separate_window_is_its_own_process.rs reads every shipped file under src that mentions a separate window, with its lines joined because both sentences wrapped, and asks that none of them says next build | 2026-09-20T15:10:00.000Z | 2026-09-22T15:17:25.000Z |
| 567 | 12 | unrun-verify | nvda-tests/tests/a-link-opens-where-the-setting-says.test.js | 160 | 12-01: the corrected link case at the next push of main, which is Pratik's. The red is run 35520201976 on main at 0ad66e48, where the case failed on its second K: NVDA said "main landmark, Where it went, link", then "document", then one empty phrase, and never example.org/written-out. That run's record settles the route and not the return, because the only evidence it kept about the return was AppActivate's answer, true, which means a window was found and asked for. The product half is settled here: tests/the_page_window_keeps_the_document_focused_when_it_comes_back.rs activates the real page window and reads the keyboard on Chrome_WidgetWin_1 inside it, after the first activation and again after a deactivation that takes the keyboard away, so the window gives the document back and no handler was added. The case now presses Alt+Tab, waits for Windows to name the page window as the window in front, falls back to activateWindow once, and writes howTheFirstReturnWorked, foregroundAfterTheFirstReturn and focusAfterTheFirstReturn before it presses K, with the same three for the second return. This never runs on this machine (nvda-tests/README.md). What the next run shows: whether Alt+Tab or activateWindow brought the window back, or neither, since Guidepup presses a chord through WScript.Shell.SendKeys as "%{TAB}" and that is not certain to reach the task switcher; and if the window did come back, whether the focused element is in the page window's document, which is what says the second K was a next-link key. A failure now names one of those instead of leaving it to be inferred from silence. Answered red on 2026-09-23 by NVDA runs 35839692317 at 26beb051 and 35839954840 at 6cb8f17c: the route held again, since Edge opened Example Domain; Alt+Tab left an untitled window of another process in front, activateWindow brought the page window back, and the focused element was the page window's own frame, wxWindowNR, so the keyboard was not in the document and the product half this entry called settled was not. 12-03.1 added a handler that gives the keyboard to the page when the window comes back with it on the frame or on nothing, and the case now records what the window's own thread says has the keyboard, sampled over three seconds, and any line the handler logs; the next run reads both. Still open, because the case green on the runner is still unanswered | fixed | Fixed by 12-03.1 on 2026-09-23: NVDA run 35876075636 on pull request #94 at 2b6efecf passed the link case, 5 passed and 1 skipped. Its record: the handler logged on both returns that the keyboard was on the frame when the window came back, so it was given to the page; the window's own thread held the keyboard on Chrome_WidgetWin_1 inside the window from 50 ms to 3,013 ms after the first return; and the focused element after each return was a link in the page. The run before it, 35872797349 at 47864cc5, was red only because the case waited for example.org/written-out where NVDA says https: slash slash example dot org slash written-out, link, and 2b6efecf made it wait for written-out. The run is a pull request's and not a push of main. Nobody has heard the fix, which is ledger 578 | 2026-09-22T12:55:00.000Z | 2026-09-23T15:06:51.000Z |
| 568 | 12 | unrun-verify | src/presentation/page_window.rs |  | 12-02: the separate window has been driven by nothing but a test, and by no screen reader at all. What is held here: the built executable refuses five addresses that are not pages and exits 2 each time, the order of the arm in main, the profile named before the browser is built, and one measured start on 2026-09-22 at 14:16:48Z that put the profile at %LOCALAPPDATA%\wixen-mail\pages\EBWebView and was removed again afterwards. What nobody has heard: the title said when the page arrives and carried in the title bar, a link on the page opening in the same window, Backspace going back and This is the first page when there is none, Escape and F6 closing the window and ending that copy, the sentence when the page will not load, the sentence when a page's script asks for another window, and Opening the site in a separate window on the surface the link came from. Also unrun: the accessibility scan over the page-window target, which runs at the next push of main and is what says whether the window's controls have names on UI Automation. The tester's ear and the runner settle these; neither has met the window | open |  | 2026-09-22T15:40:00.000Z |  |
| 569 | 12 | deviation | scripts/guards.py |  | 12-02.1: what really ended shard 40 of the guard sweep, run 35520204784 of 2026-09-20, and it was not the shard size. The longest shard that finished was shard 18 at 7,442 s, 2 h 4 min against a 360-minute cap, and twenty records at that sweep's own 223 s mean is about 79 minutes. Shard 40 logged 2,637 s of measured work, printed the header of "the settings dialog is frozen while its pages are built", never printed a timing line, and its job ran 21,615 s before the cap ended it, so about 5 h 16 min went inside that one record with nine records left unmeasured. The cause was that scripts/guards.py bounded nothing: neither a record nor a suite's pre-read, and shard 40's first pre-read alone took 809 s. A record that does not return cost a whole shard whatever the shard count was. The findings document this plan was written from recommends dispatching the next sweep at about 70 shards rather than 52, and that is not the remedy and the arithmetic says so: at 70 shards the same record hangs in whichever shard holds it and takes that shard with it, while every other shard was already inside the cap by a factor of nearly three | fixed | Fixed by 12-02.1 on 2026-09-22. scripts/guards.py now holds every record, and every suite's pre-read, to one wall-clock budget shared by its build and its run, THE_LONGEST_A_RECORD_MAY_TAKE at 1,800 s, just under four times the 456 s the longest record to finish anywhere in that sweep took. What passes it is killed with the processes cargo started under it, through taskkill walking the tree, reported unmeasured with the seconds it reached and which term it was in, and the run goes on to the next record or suite; the closing line counts what a run gave up on and the run exits 1, so a run that hit the limit cannot read as clean. The workflow passes it from a declared time_limit input, and timeout-minutes 360 stays as the backstop. Proved on both paths by hand before it was relied on, and then relied on: the hanging record was given up on at 1,800 s in this plan's task 6 and the run measured the four records after it | 2026-09-22T20:27:00.000Z | 2026-09-22T20:27:00.000Z |
| 570 | 12 | deviation | src/application/calendar.rs |  | 12-02.1: two guard records cost every sweep a build and a run each and can never be judged there. "an hour with no zone means an hour here, to Outlook as well as to Google" needs a clock that is not UTC, and a runner's is UTC, so chrono Local and chrono Utc are the same conversion and the break changes nothing. "the walk into Windows own chain structures really happens", in src/service/signed_mail.rs, needs a certificate chain to walk, and GitHub's Windows images have none, so the arm the break replaces is never reached. Both were green on the runners in run 34965790937 of 2026-09-15 and again in run 35520204784 of 2026-09-20, and both were measured red here on 2026-09-22. Each now says so on itself, which is what the 2026-09-15 sweep said it would do and wrote at the top of the file instead. What is still owed: nothing skips them, so a third sweep pays for them again, now bounded rather than unbounded. A skip would take a way for a record to declare what its measurement needs and for the runner to answer whether this machine has it, which is a mechanism nothing here has and which no measurement in this plan settles | open |  | 2026-09-22T20:27:00.000Z |  |
...
| 576 | 12 | unrun-verify | nvda-tests/tests/calendar-immediate-actions.test.js |  | 12-03.1: the calendar and filter cases green on the runner under the corrected waits. Runs 35839692317 and 35839954840 failed both on sentences 12-03 had reworded, while NVDA heard the new ones. The cases now wait for Choose an event first. after Edit Event and again after Delete Event, each counting only what NVDA said after its own key, for Syncing the calendar... after Sync, and for Choose a filter first. in the filter manager; tests/the_nvda_cases_wait_for_words_the_program_says.rs holds every waited text to the place in src that says it, on every code commit. What only the runner settles: that NVDA speaks each of them where the case waits, which is FOUND-22's [S] line | fixed | Fixed by 12-03.1 on 2026-09-23: NVDA runs 35872797349 at 47864cc5 and 35876075636 at 2b6efecf, both on pull request #94, passed calendar-immediate-actions and filter-manager-delete. The second run's transcripts hold Choose an event first. after Edit Event and again after Delete Event, Syncing the calendar... after Sync, and Choose a filter first. after Delete in the filter manager, so NVDA speaks each of them where the case waits | 2026-09-23T14:10:00.000Z | 2026-09-23T15:06:51.000Z |
...
[
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Starts Day over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
    "recorded_at": "2026-09-14T15:28:39.988Z",
    "resolved_at": "2026-09-23T21:30:21.000Z"
  },
  {
    "id": 409,
    "kind": "todo",
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Starts Year over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Start time Minute over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Ends Day over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Ends Year over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers End time Minute over MSAA and over UI Automation, the same words as its arrows, read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send on Day over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send on Year over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send at Hour over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Send at Minute over MSAA and over UI Automation, the same words as its arrows, read on the built Send Later window by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-06 on 2026-09-23 at b439452e: the typing field answers Start time Hour over MSAA and over UI Automation, the same words as its arrows, where it answered nothing on MSAA and Start time, the label before it, on UI Automation; read on the built event form by tests/every_spin_control_names_the_field_a_person_types_in.rs; the scan reads it again at the next push",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "11-11.0, 2026-09-20: a block met inside inline content is read with a space either side, a cell's spacing is collapsed, a div holding blocks is walked as blocks, and a table the sender marked presentation is read as its blocks in order and never as a Table piece; the newsletter's four joins apart and a cell holding two paragraphs, held by tests/what_the_sender_hid_is_not_read.rs, no case added in long_text.rs",
    "recorded_at": "2026-09-19T17:45:00.000Z",
    "resolved_at": "2026-09-20T02:32:39.000Z"
  },
  {
    "id": 556,
    "kind": "unrun-verify",
  ...
  },
  {
    ...
    "file": "src/presentation/html_renderer.rs",
    "line": null,
    "description": "11-11: what only the tester's reader settles for #28. A newsletter's pictures shown in the preview pane on a fresh profile, and on his, where the switch was already off; a one-pixel beacon passed over with \"1 picture that looked like a tracking pixel was not fetched.\" heard once at the top; a linked picture with no description heard as the link's words; an undescribed picture heard as nothing under the default and as \"image\" or \"photo\" once chosen on the Reading tab; a remote picture the sender marked decorative passed over, or heard as \"Picture the sender marked decorative\" with that box on; a note with an undescribed picture read with Space and the picture passed over. The rules through the real cleaner, the renderer's order, the sending path untouched and the choice read back from the built dialog are held by tests/pictures_show_by_default_except_beacons.rs; none of it has been heard",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-20T00:20:25.000Z",
    "resolved_at": null
  },
  {
    "id": 559,
    ...
    "file": "src/presentation/html_renderer.rs",
    "line": null,
    "description": "11-11.0: what only the tester's ear settles for #90. The Substack newsletter he named, read in the formatted view under NVDA: the subtitle heard once, where the sender's own line stands and not at the top; no run of symbols where the padding was; no \"table with N rows and N columns\" around any block; no \"Post header\" grouping announced; the subject heard once, as the heading, and the sender once, in the heading with no number before it; and another newsletter of his choosing read the same way. The drop, the count line, the roles, the label rule, the page's own markup and the reader's structure are held by tests/what_the_sender_hid_is_not_read.rs over the fixture; none of it has been heard",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-20T02:32:39.000Z",
    "resolved_at": null
  },
  {
    "id": 560,
    ...
    "file": "src/presentation/wx_app.rs",
    "line": null,
    "description": "11-11.1: what only the tester's ear and the NVDA run settle for #80. Enter on a link under NVDA, on the preview pane and on the formatted message window, going where Open links says: the browser under the default, the page in the message view with \"Opening\" and the host said, the title said once when it arrives, and \"Back to the message\" on Backspace or Alt+Left; the link's menu on the Applications key offering the three places on both surfaces; a page that will not load saying why; the separate window choice opening the browser with its status line. The listener, the route table, the three items, the arms, the sanitiser first and the second line are held by tests/a_link_opens_where_the_setting_says.rs, and the probe's finding is measured there against a built browser control; the NVDA case a-link-opens-where-the-setting-says.test.js is written and runs at the next push of main; none of it has been heard",
    "status": "open",
    "reason": "",
  ...
  },
  {
    ...
    "file": "src/presentation/wx_app.rs",
    "line": null,
    "description": "11-11.1.2: what only the tester's ear settles for the first half of #92. A folder never set opened on a fresh profile and heard as conversation rows, with the Thread View check mark on; Show conversations by default turned off under Settings, Reading, OK, then the next folder never set opened and heard as one row per message, without a restart; a folder set flat by hand still flat with the setting on; the check box heard by its name and state on the Reading tab after Then by. The rule, the landing reading the setting where the folder opens, the box on the built page and its readback are held by src/presentation/view_state.rs and tests/the_settings_dialog_opens_in.rs; none of it has been heard",
    "status": "open",
    "reason": "",
  ...
  },
  {
    ...
    "file": "src/presentation/editor_document.rs",
    "line": null,
    "description": "11-11.3: what only the tester's ear settles for #79, with NVDA in focus mode in the message body, a moment's wait after each Space since NVDA cuts speech on the next key. 1: a new message, first line, number sign, number sign, Space, a word: hear Heading level 2 after the Space, and Up then Down reads the line as a heading with the number signs gone. 2: a reply to a message that arrived as plain text, Down once into the quoted text, Home, then number sign, number sign, Space, a word: hear Heading level 2; this is the case that was broken, and before the fix it said nothing and the number signs stayed. 3: the same reply, back at the top, Enter once on the empty first line, then the marker with its Space: hear Heading level 2. 4: a new message, a word, Shift+Enter, then the marker with its Space: hear Heading level 2. 5: a new message, number sign, number sign, a word, Space, with no space after the signs: hear nothing, and the signs stay; this is not a heading and never was. 6: on any line, two stars, a word, two stars, then a word: hear Bold at the closing star, and the word after it read plain; then a hyphen, Space and a word on a new line: hear Bulleted list. 7: Ctrl+Enter to the preview after 1 to 4, then H in the preview: land on each heading. 8: a misspelt word on a heading line with earcons on: the short sound at the end of the word still plays. The reading in tests/a_marker_counts_at_the_start_of_any_line.rs holds the document after each of 1 to 6 on the real page with posted keys, never through a screen reader's hook; none of it has been heard",
    "status": "open",
    "reason": "",
  ...
  },
  {
    ...
    "status": "fixed",
    "reason": "Fixed by 12-02 on 2026-09-22, the plan 11-11.2 became. The window exists: a1774d9e built the page process, its window and its browser profile of its own, and the green after c192ad03 pointed the third route at it. WHAT_EACH_CHOICE_COSTS now ends by saying a separate Wixen Mail window is a process of its own with a browser profile of its own that shares nothing with the message preview and closes when the window does; SEPARATE_WINDOWS_ARRIVE_LATER is gone with the arm that spoke it, and test_the_words_on_the_reading_tab_name_the_trade, the test that held the first sentence to the words next build, holds it to profile, Backspace and process and to saying nothing about a build. test_nothing_in_the_program_still_says_a_separate_window_is_coming in tests/a_separate_window_is_its_own_process.rs reads every shipped file under src that mentions a separate window, with its lines joined because both sentences wrapped, and asks that none of them says next build",
    "recorded_at": "2026-09-20T15:10:00.000Z",
    "resolved_at": "2026-09-22T15:17:25.000Z"
  },
  {
    "id": 567,
    "kind": "unrun-verify",
    "phase": "12",
    "file": "nvda-tests/tests/a-link-opens-where-the-setting-says.test.js",
    "line": 160,
    "description": "12-01: the corrected link case at the next push of main, which is Pratik's. The red is run 35520201976 on main at 0ad66e48, where the case failed on its second K: NVDA said \"main landmark, Where it went, link\", then \"document\", then one empty phrase, and never example.org/written-out. That run's record settles the route and not the return, because the only evidence it kept about the return was AppActivate's answer, true, which means a window was found and asked for. The product half is settled here: tests/the_page_window_keeps_the_document_focused_when_it_comes_back.rs activates the real page window and reads the keyboard on Chrome_WidgetWin_1 inside it, after the first activation and again after a deactivation that takes the keyboard away, so the window gives the document back and no handler was added. The case now presses Alt+Tab, waits for Windows to name the page window as the window in front, falls back to activateWindow once, and writes howTheFirstReturnWorked, foregroundAfterTheFirstReturn and focusAfterTheFirstReturn before it presses K, with the same three for the second return. This never runs on this machine (nvda-tests/README.md). What the next run shows: whether Alt+Tab or activateWindow brought the window back, or neither, since Guidepup presses a chord through WScript.Shell.SendKeys as \"%{TAB}\" and that is not certain to reach the task switcher; and if the window did come back, whether the focused element is in the page window's document, which is what says the second K was a next-link key. A failure now names one of those instead of leaving it to be inferred from silence. Answered red on 2026-09-23 by NVDA runs 35839692317 at 26beb051 and 35839954840 at 6cb8f17c: the route held again, since Edge opened Example Domain; Alt+Tab left an untitled window of another process in front, activateWindow brought the page window back, and the focused element was the page window's own frame, wxWindowNR, so the keyboard was not in the document and the product half this entry called settled was not. 12-03.1 added a handler that gives the keyboard to the page when the window comes back with it on the frame or on nothing, and the case now records what the window's own thread says has the keyboard, sampled over three seconds, and any line the handler logs; the next run reads both. Still open, because the case green on the runner is still unanswered",
    "status": "fixed",
    "reason": "Fixed by 12-03.1 on 2026-09-23: NVDA run 35876075636 on pull request #94 at 2b6efecf passed the link case, 5 passed and 1 skipped. Its record: the handler logged on both returns that the keyboard was on the frame when the window came back, so it was given to the page; the window's own thread held the keyboard on Chrome_WidgetWin_1 inside the window from 50 ms to 3,013 ms after the first return; and the focused element after each return was a link in the page. The run before it, 35872797349 at 47864cc5, was red only because the case waited for example.org/written-out where NVDA says https: slash slash example dot org slash written-out, link, and 2b6efecf made it wait for written-out. The run is a pull request's and not a push of main. Nobody has heard the fix, which is ledger 578",
    "recorded_at": "2026-09-22T12:55:00.000Z",
    "resolved_at": "2026-09-23T15:06:51.000Z"
  },
  {
    "id": 568,
    "kind": "unrun-verify",
    ...
    "line": null,
    "description": "12-02: the separate window has been driven by nothing but a test, and by no screen reader at all. What is held here: the built executable refuses five addresses that are not pages and exits 2 each time, the order of the arm in main, the profile named before the browser is built, and one measured start on 2026-09-22 at 14:16:48Z that put the profile at %LOCALAPPDATA%\\wixen-mail\\pages\\EBWebView and was removed again afterwards. What nobody has heard: the title said when the page arrives and carried in the title bar, a link on the page opening in the same window, Backspace going back and This is the first page when there is none, Escape and F6 closing the window and ending that copy, the sentence when the page will not load, the sentence when a page's script asks for another window, and Opening the site in a separate window on the surface the link came from. Also unrun: the accessibility scan over the page-window target, which runs at the next push of main and is what says whether the window's controls have names on UI Automation. The tester's ear and the runner settle these; neither has met the window",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-22T15:40:00.000Z",
    "resolved_at": null
  },
  {
    "id": 569,
    ...
    "file": "scripts/guards.py",
    "line": null,
    "description": "12-02.1: what really ended shard 40 of the guard sweep, run 35520204784 of 2026-09-20, and it was not the shard size. The longest shard that finished was shard 18 at 7,442 s, 2 h 4 min against a 360-minute cap, and twenty records at that sweep's own 223 s mean is about 79 minutes. Shard 40 logged 2,637 s of measured work, printed the header of \"the settings dialog is frozen while its pages are built\", never printed a timing line, and its job ran 21,615 s before the cap ended it, so about 5 h 16 min went inside that one record with nine records left unmeasured. The cause was that scripts/guards.py bounded nothing: neither a record nor a suite's pre-read, and shard 40's first pre-read alone took 809 s. A record that does not return cost a whole shard whatever the shard count was. The findings document this plan was written from recommends dispatching the next sweep at about 70 shards rather than 52, and that is not the remedy and the arithmetic says so: at 70 shards the same record hangs in whichever shard holds it and takes that shard with it, while every other shard was already inside the cap by a factor of nearly three",
    "status": "fixed",
    "reason": "Fixed by 12-02.1 on 2026-09-22. scripts/guards.py now holds every record, and every suite's pre-read, to one wall-clock budget shared by its build and its run, THE_LONGEST_A_RECORD_MAY_TAKE at 1,800 s, just under four times the 456 s the longest record to finish anywhere in that sweep took. What passes it is killed with the processes cargo started under it, through taskkill walking the tree, reported unmeasured with the seconds it reached and which term it was in, and the run goes on to the next record or suite; the closing line counts what a run gave up on and the run exits 1, so a run that hit the limit cannot read as clean. The workflow passes it from a declared time_limit input, and timeout-minutes 360 stays as the backstop. Proved on both paths by hand before it was relied on, and then relied on: the hanging record was given up on at 1,800 s in this plan's task 6 and the run measured the four records after it",
    "recorded_at": "2026-09-22T20:27:00.000Z",
    "resolved_at": "2026-09-22T20:27:00.000Z"
  },
  {
    "id": 570,
    "kind": "deviation",
    ...
    "file": "src/application/calendar.rs",
    "line": null,
    "description": "12-02.1: two guard records cost every sweep a build and a run each and can never be judged there. \"an hour with no zone means an hour here, to Outlook as well as to Google\" needs a clock that is not UTC, and a runner's is UTC, so chrono Local and chrono Utc are the same conversion and the break changes nothing. \"the walk into Windows own chain structures really happens\", in src/service/signed_mail.rs, needs a certificate chain to walk, and GitHub's Windows images have none, so the arm the break replaces is never reached. Both were green on the runners in run 34965790937 of 2026-09-15 and again in run 35520204784 of 2026-09-20, and both were measured red here on 2026-09-22. Each now says so on itself, which is what the 2026-09-15 sweep said it would do and wrote at the top of the file instead. What is still owed: nothing skips them, so a third sweep pays for them again, now bounded rather than unbounded. A skip would take a way for a record to declare what its measurement needs and for the runner to answer whether this machine has it, which is a mechanism nothing here has and which no measurement in this plan settles",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-22T20:27:00.000Z",
    "resolved_at": null
  },
  {
    ...
    "file": "src/presentation/wx_settings.rs",
    "line": null,
    "description": "12-02.1: one guard record does not return when broken, and no machine has measured it since 2026-09-17. \"the settings dialog is frozen while its pages are built\" ended shard 40 of run 35520204784, ended run 35726150488 which was dispatched on its own to finish that shard, and was given up on here at 1,800 s on 2026-09-22 with the kill taking the tree and the guarded file put back. The hang is itself evidence about the freeze rather than a fault in the record: an unfrozen build repaints per control, and the measurement of 2026-09-16 put the typeface list alone at about a second unfrozen against a tenth of that frozen, over one list of the dialog. What it would take to measure it: a way to run tests/the_settings_dialog_opens_in with the break in place and a bound on the repainting, so the suite answers rather than never returning. Do not lower the record and do not guess a verdict",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-22T20:27:00.000Z",
    "resolved_at": null
  },
  {
    ...
    "file": "src/service/onenote_page.rs",
    "line": 226,
    "description": "12-02.1: without_the_wrapping_divs is redundant and in one shape harmful, and the guard over it was retired rather than rewritten because a test asserting what it now does would write a defect down as a rule. It strips every div from a OneNote page body before long_text reads it, which was load-bearing until d470a105 split the shared p and div arm: a div holding a block child is now walked as blocks. Measured on 2026-09-22 by putting six page shapes through from_markup_to_edit twice, once stripped and once kept. Identical for every shape holding a block. Where a div holds only a line of words the stripping cuts the line at every inline element and takes a link address with it: div a link here read \"a\" \"link\" \"here\" as three paragraphs stripped, against \"a [link](https://x) here\" kept. That is a loss on a round trip through the note editor, which is the one thing from_markup_to_edit exists to prevent. What is owed: somebody deciding whether the stripping comes out, and a test written for whichever answer",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-22T20:27:00.000Z",
    "resolved_at": null
  },
  {
    ...
    "file": ".github/workflows/guards.yml",
    "line": null,
    "description": "12-02.1: one test fails on GitHub's runners under breaks that have nothing to do with it, and the guard sweep read that as five short records. service::spellcheck::tests::test_the_source_named_without_a_checker_is_the_one_a_checker_built_would_report appeared as the single unnamed red test for five records of run 35520204784, on shards 2, 19, 23, 27 and 44, under breaks about a task read writing back a deletion, an Outlook range carrying its start date, an unwanted-software hash being named, switching the view back, and a row size on a message with no text here. Nothing couples those to a spelling source. All five records were measured here on 2026-09-22 and all five agree with the tree exactly as they stand. What is owed: why that test fails on a runner and why the per-suite pre-read did not subtract it, since a failure the pre-read sees is taken off every record. Until that is known, a sweep's short records need reading against this name before any of them is believed",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-22T20:27:00.000Z",
    "resolved_at": null
  ...
  },
  {
    ...
    "kind": "unrun-verify",
    "phase": "12",
    "file": "nvda-tests/tests/calendar-immediate-actions.test.js",
    "line": null,
    "description": "12-03.1: the calendar and filter cases green on the runner under the corrected waits. Runs 35839692317 and 35839954840 failed both on sentences 12-03 had reworded, while NVDA heard the new ones. The cases now wait for Choose an event first. after Edit Event and again after Delete Event, each counting only what NVDA said after its own key, for Syncing the calendar... after Sync, and for Choose a filter first. in the filter manager; tests/the_nvda_cases_wait_for_words_the_program_says.rs holds every waited text to the place in src that says it, on every code commit. What only the runner settles: that NVDA speaks each of them where the case waits, which is FOUND-22's [S] line",
    "status": "fixed",
    "reason": "Fixed by 12-03.1 on 2026-09-23: NVDA runs 35872797349 at 47864cc5 and 35876075636 at 2b6efecf, both on pull request #94, passed calendar-immediate-actions and filter-manager-delete. The second run's transcripts hold Choose an event first. after Edit Event and again after Delete Event, Syncing the calendar... after Sync, and Choose a filter first. after Delete in the filter manager, so NVDA speaks each of them where the case waits",
  ...
  },
  {
    ...
    "kind": "unrun-verify",
    "phase": "12",
    "file": "nvda-tests/helpers/launch-app.js",
    "line": null,
    "description": "12-03.1: Alt+Tab on the runner. In runs 35839692317 and 35839954840 the link case pressed Alt+Tab to come back to the page window and, when its ten seconds ran out, the window in front was an untitled one of another process, pid 2036, while NVDA had called the Edge window unavailable; activateWindow then brought the page window back. The likeliest reading is a first-run window of Edge's disabling its main window. foregroundWindow now records the class and the process name of the window in front, so the next run says whose that window is, and whether Alt+Tab is worth keeping as the first way back",
    "status": "fixed",
    "reason": "Fixed by 12-03.1 on 2026-09-23, answered: in NVDA run 35876075636 on pull request #94 at 2b6efecf, Alt+Tab brought the page window back on neither return, and both times the window in front when its ten seconds ran out was an untitled Chrome_WidgetWin_1 of msedge, pid 1464, which is Edge's; activateWindow brought the page window back both times. Whether Alt+Tab stays as the first way back is not decided here",
    "recorded_at": "2026-09-23T14:10:00.000Z",
    "resolved_at": "2026-09-23T15:06:51.000Z"
  },
  {
    ...
    "kind": "unrun-verify",
    "phase": "12",
    "file": "src/presentation/page_focus.rs",
    "line": null,
    "description": "12-03.1: the tester's ear. Switching away from the window that shows a conversation as headings and back, under NVDA, then pressing K or H at once: the keyboard should be in the message and the key should move. What is held here is a message a test sends to a built window, reproducing the one path in wxWidgets that leaves the keyboard on the frame; a real switch is read only by the NVDA workflow, and nobody has heard it. Also to hear: moving to the attachments list or the warning bar, switching away and back, and finding the keyboard still there",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-23T14:10:00.000Z",
    "resolved_at": null
  },
  {
    ...
    "file": "src/presentation/page_window.rs",
    "line": 186,
    "description": "12-03.1: the separate window has no such handler. Its frame has no parent, so the wxWidgets path that restores a frame to itself, because it was saved as its own last focused child, cannot happen there: with no parent the saved frame is dropped and the first child that takes the keyboard gets it. The other two ways the keyboard could be lost on coming back, an activation wxWidgets drops because it arrives marked minimised, and the browser letting the keyboard go after a real foreground change, are unmeasured on it. Owed: the frame-saved reading's shape over the separate window, and presentation::page_focus bound there if it comes back red",
    "status": "open",
    "reason": "",
    "recorded_at": "2026-09-23T14:10:00.000Z",
    "resolved_at": null
