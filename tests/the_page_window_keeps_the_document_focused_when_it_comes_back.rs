...
//! measuring. So the reading does what
...
impl Reading {
    fn take(the_window_this_step_is_about: isize) -> Self {
        ...
        Self {
            ...
            in_front,
            in_front_title: window_title(in_front),
        }
    }
    ...
    let result = {
        ...
        wxdragon::main(move |app| {
            ...
            let parts: Vec<ConversationPart> = scan_fixtures::page_conversation()
                ...
                .collect();
            wx_app::show_conversation_as_page(&parent, &reader, &a11y, "Scan target", &parts, None);
